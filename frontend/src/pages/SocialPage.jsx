...
export default function SocialPage() {
  ...
  return (
    <div className='p-4 bg-slate-950 min-h-screen'>
      <button className='bg-orange-500 px-3 py-2 rounded' onClick={submit}>Generate Social Engine</button>
      <pre className='text-white text-xs mt-4 whitespace-pre-wrap'>{JSON.stringify(data, null, 2)}</pre>
    </div>
  );
}
