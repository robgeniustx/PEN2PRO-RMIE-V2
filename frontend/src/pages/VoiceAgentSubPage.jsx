    ...
    <div className="min-h-screen bg-[#0A0F1E] text-white">
      ...
      <div className="mx-auto max-w-4xl px-5 py-20 text-center">
        ...
        <div className="rounded-2xl border border-emerald-500/30 bg-emerald-500/10 p-10">
          ...
          <p className="mb-2 font-bold text-white">Access enabled for AI Voice Agent.</p>
          ...
          <div className="flex flex-col items-center gap-3 sm:flex-row sm:justify-center">
            <Link to="/voice-agent" className="rounded-xl px-6 py-3 text-sm font-black text-[#0A0F1E] btn-gold">Voice Agent Overview</Link>
          </div>
        </div>
        ) : (
        <div className="rounded-2xl border border-[#1A2D50] bg-[#0F1520] p-10">
          ...
          <p className="mb-8 text-sm text-slate-400">The P2P AI Voice Agent and all sub-features require a Pro or Elite subscription.</p>
          <div className="flex flex-col items-center gap-3 sm:flex-row sm:justify-center">
            <Link to="/pricing" className="rounded-xl px-6 py-3 text-sm font-black text-[#0A0F1E] btn-gold">Upgrade Now</Link>
            <Link to="/voice-agent" className="rounded-xl border border-[#1A2D50] px-6 py-3 text-sm font-semibold text-slate-300 hover:text-white transition-colors">Voice Agent Overview</Link>
          </div>
        </div>
        )}
