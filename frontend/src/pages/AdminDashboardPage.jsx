          ...
          <>
            ...
            <div className="mb-8 grid grid-cols-2 gap-4 md:grid-cols-4">
              {[
                ...
                { label: "Pro Interest", value: (data.by_interest?.["Pro Plan ($249/mo)"] ?? 0) + (data.by_interest?.["Pro Plan ($47/mo)"] ?? 0), color: "#00C9B1" },
                { label: "Elite Interest", value: (data.by_interest?.["Elite Plan ($499/mo)"] ?? 0) + (data.by_interest?.["Elite Plan ($97/mo)"] ?? 0), color: "#D4A017" },
                { label: "Founders Interest", value: (data.by_interest?.["Founders Lifetime ($1,899)"] ?? 0) + (data.by_interest?.["Founders Lifetime ($497)"] ?? 0), color: "#D4A017" },
              ].map((m, i) => (
