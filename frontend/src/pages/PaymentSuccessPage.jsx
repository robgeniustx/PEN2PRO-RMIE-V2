...
const TIER_INFO = {
  ...
  pro: {
    ...
    next: [
      ...
      "Log in to your dashboard and start building your first full roadmap.",
    ],
  },
  elite: {
    name: "Elite",
    ...
    next: [
      ...
      "Elite access — including done-with-you strategy guidance — is now active.",
  ...
  default: {
    ...
    next: [
      ...
      "Your access is now active — log in to get started.",
