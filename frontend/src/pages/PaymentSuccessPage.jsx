...
const TIER_INFO = {
  founders: {
    ...
    next: [
      ...
      "You'll receive early access to all platform features — Founders close August 1, 2026.",
  ...
  pro: {
    ...
    next: [
      ...
      "Pro access is live — unlimited roadmaps, outreach automation, credit readiness, and more.",
  ...
  elite: {
    ...
    next: [
      ...
      "Elite access — including done-with-you strategy sessions — is now active.",
  ...
  default: {
    ...
    next: [
      ...
      "Your access is now active — start building your roadmap today.",
