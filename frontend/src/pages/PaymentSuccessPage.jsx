...
import { LAUNCH_DATE_DISPLAY } from "../utils/constants";
...
const TIER_INFO = {
  founders: {
    ...
    next: [
      ...
      `You'll receive early access to all platform features starting ${LAUNCH_DATE_DISPLAY}.`,
  ...
  pro: {
    ...
    next: [
      ...
      `Pro access unlocks fully on ${LAUNCH_DATE_DISPLAY} — unlimited roadmaps, outreach automation, and more.`,
  ...
  elite: {
    ...
    next: [
      ...
      `Elite access — including done-with-you strategy sessions — activates ${LAUNCH_DATE_DISPLAY}.`,
  ...
  default: {
    ...
    next: [
      ...
      `Your access activates on ${LAUNCH_DATE_DISPLAY} at launch.`,
