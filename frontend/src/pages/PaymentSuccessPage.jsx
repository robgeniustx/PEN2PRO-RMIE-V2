...
const TIER_INFO = {
  founders: {
    ...
    next: [
      ...
      "Your Founders Lifetime access is now active — log in to start building.",
  ...
  pro: {
    ...
    next: [
      ...
      "Pro access is now live — unlimited roadmaps, outreach automation, and more.",
      "Log in to your dashboard and start building your first full blueprint.",
    ],
  },
  elite: {
    name: "Elite",
    ...
    next: [
      ...
      "Elite access — including done-with-you strategy and financial projections — is active now.",
  ...
  default: {
    ...
    next: [
      ...
      "Your access is active — log in to your dashboard to get started.",
      "Generate a free business roadmap and explore your tier benefits.",
    ],
  },
};
