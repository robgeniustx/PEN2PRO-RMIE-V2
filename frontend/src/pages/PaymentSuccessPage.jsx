...
const TIER_INFO = {
  ...
  pro: {
    ...
    next: [
      ...
      "Pro access is now active — log in to access your full RMIE blueprint and dashboard.",
      "Your roadmap, branding support, PDF export, and outreach tools are ready now.",
    ],
  },
  elite: {
    name: "Elite",
    ...
    next: [
      ...
      "Elite access is now active — log in to access advanced strategy, projections, and priority support.",
  ...
  default: {
    ...
    next: [
      ...
      "Generate a free business roadmap to get started.",
    ],
  },
};
