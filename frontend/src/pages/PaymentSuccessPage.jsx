...
const TIER_INFO = {
  founders: {
    ...
    next: [
      ...
      "Your Founders Lifetime access is now active — all platform features are unlocked.",
  ...
  default: {
    ...
    next: [
      ...
      "Your access is now active — log in to start building your business roadmap.",
