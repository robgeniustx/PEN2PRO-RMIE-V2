...
const TIER_INFO = {
  founders: {
    ...
    next: [
      ...
      "Your platform access is active now — all Founders features are live.",
  ...
  elite: {
    ...
    next: [
      ...
      "Your Elite access is active now — including done-with-you strategy sessions.",
  ...
  default: {
    ...
    next: [
      ...
      "Your access is active now — the platform is live.",
