...
const TIER_INFO = {
  founders: {
    ...
    next: [
      ...
      "You have lifetime access to all platform features — welcome to the Founders circle.",
  ...
  pro: {
    ...
    next: [
      ...
      "Pro access is now active — unlimited roadmaps, outreach automation, and credit readiness tools.",
      "Generate your first full roadmap to get started.",
    ],
  },
  elite: {
    name: "Elite",
    ...
    next: [
      ...
      "Elite access is now active — including done-with-you strategy and advanced RMIE tools.",
  ...
  default: {
    ...
    next: [
      ...
      "Your access is now active — welcome to PEN2PRO.",
      "Generate your first free business roadmap to get started.",
    ],
  },
};
