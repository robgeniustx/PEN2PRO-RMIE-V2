...
const TIER_INFO = {
  founders: {
    ...
    price: "$1,899 — lifetime access",
    color: "#D4A017",
    next: [
      "Check your email for your PEN2PRO confirmation and receipt.",
      "Your Founders Lifetime access is active — log in to your dashboard to get started.",
  ...
  pro: {
    ...
    next: [
      ...
      "Pro access is now active — unlimited roadmaps, outreach automation, and credit/funding tools unlocked.",
      "Head to your dashboard to start your first full blueprint.",
    ],
  },
  elite: {
    name: "Elite",
    ...
    next: [
      ...
      "Elite access is now active — including done-with-you strategy, financial projections, and vendor resources.",
  ...
  default: {
    ...
    next: [
      ...
      "Generate a free business roadmap to begin your plan.",
    ],
  },
};
