...
const TIER_INFO = {
  founders: {
    ...
    next: [
      ...
      "Your Founders Lifetime access is being activated — check your email for confirmation.",
  ...
  elite: {
    ...
    next: [
      ...
      "Your Elite access — including done-with-you strategy sessions — is now active.",
  ...
  default: {
    ...
    next: [
      ...
      "Your access is being activated — check your dashboard to get started.",
