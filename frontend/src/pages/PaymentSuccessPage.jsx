...
const TIER_INFO = {
  founders: {
    ...
    next: [
      ...
      "You'll receive early access to all platform features at full launch on August 1, 2026.",
  ...
  pro: {
    ...
    next: [
      ...
      "Pro access unlocks fully at launch on August 1, 2026 — unlimited roadmaps, outreach automation, and more.",
  ...
  elite: {
    ...
    next: [
      ...
      "Elite access — including done-with-you strategy sessions — activates August 1, 2026.",
  ...
  default: {
    ...
    next: [
      ...
      "Your full access activates August 1, 2026 at launch.",
