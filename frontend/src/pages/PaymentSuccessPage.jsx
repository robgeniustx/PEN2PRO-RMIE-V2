...
const TIER_INFO = {
  founders: {
    ...
    next: [
      ...
      "Your Founders Lifetime access is now active — log in to your dashboard.",
  ...
  pro: {
    ...
    next: [
      ...
      "Pro access is now active — unlimited roadmaps, outreach tools, branding support, and more.",
      "Log in to your dashboard to start building your full business blueprint.",
    ],
  },
  elite: {
    name: "Elite",
    ...
    next: [
      ...
      "Elite access is now active — including done-with-you strategy sessions and advanced AI.",
      "Reach out to our team at support@pen2pro.com to schedule your onboarding session.",
    ],
  },
  default: {
    name: "PEN2PRO",
    ...
    next: [
      ...
      "Your access is now active — log in to your dashboard to get started.",
      "Generate a free business roadmap to kick off your journey.",
    ],
  },
};
