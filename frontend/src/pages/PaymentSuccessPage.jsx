...
const TIER_INFO = {
  founders: {
    ...
    next: [
      ...
      "Your Founders access is now active — check your email for login details.",
  ...
  pro: {
    ...
    next: [
      ...
      "Your Pro access is now active — unlimited roadmaps, outreach automation, and more.",
  ...
  elite: {
    ...
    next: [
      ...
      "Your Elite access is now active — done-with-you strategy sessions are available in your dashboard.",
  ...
  default: {
    ...
    next: [
      ...
      "Your access is now active — check your email for login details.",
