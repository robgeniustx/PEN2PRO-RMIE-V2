...
const TIER_INFO = {
  founders: {
    ...
    next: [
      ...
      "You have full access to all platform features — start building your roadmap now.",
  ...
  pro: {
    ...
    next: [
      ...
      "Pro access is active now — unlimited roadmaps, outreach automation, and more are ready to use.",
  ...
  elite: {
    ...
    next: [
      ...
      "Elite access is active now — including done-with-you strategy sessions and advanced tools.",
  ...
  default: {
    ...
    next: [
      ...
      "Your access is active now — log in and start building your business roadmap.",
