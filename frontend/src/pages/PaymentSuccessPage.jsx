...
const TIER_INFO = {
  founders: {
    ...
    next: [
      ...
      "You now have full access to all platform features — welcome to the Founders circle.",
  ...
  pro: {
    ...
    next: [
      ...
      "Your Pro access is now active — unlimited roadmaps, outreach automation, and full RMIE blueprints.",
  ...
  elite: {
    ...
    next: [
      ...
      "Your Elite access is now active — done-with-you strategy sessions are ready to schedule.",
  ...
  default: {
    ...
    next: [
      ...
      "Your access is now active — go to your dashboard to get started.",
