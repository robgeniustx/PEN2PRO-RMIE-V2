...
import { LAUNCH_DATE_LABEL } from "../utils/constants";
...
const TIER_INFO = {
  founders: {
    ...
    next: [
      ...
      `You'll receive early access to all platform features starting ${LAUNCH_DATE_LABEL}.`,
  ...
  pro: {
    ...
    next: [
      ...
      `Pro access unlocks fully on ${LAUNCH_DATE_LABEL} — unlimited roadmaps, outreach automation, and more.`,
  ...
  elite: {
    ...
    next: [
      ...
      `Elite access — including done-with-you strategy sessions — activates ${LAUNCH_DATE_LABEL}.`,
  ...
  default: {
    ...
    next: [
      ...
      `Your access activates on ${LAUNCH_DATE_LABEL} at launch.`,
