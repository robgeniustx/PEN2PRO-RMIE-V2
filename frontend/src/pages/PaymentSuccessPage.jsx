...
const TIER_INFO = {
  founders: {
    ...
    next: [
      ...
      "You'll receive early access to all platform features starting August 1, 2026.",
  ...
  pro: {
    ...
    next: [
      ...
      "Pro access unlocks fully on August 1, 2026 — unlimited roadmaps, outreach automation, and more.",
  ...
  default: {
    ...
    next: [
      ...
      "Your access activates on August 1, 2026 at launch.",
