...
const TIER_INFO = {
  founders: {
    ...
    next: [
      ...
      "You now have full access to all platform features — log in to get started.",
  ...
  pro: {
    ...
    next: [
      ...
      "Pro access is active — unlimited roadmaps, outreach automation, and more.",
  ...
  elite: {
    ...
    next: [
      ...
      "Elite access is active — including done-with-you strategy sessions and priority support.",
