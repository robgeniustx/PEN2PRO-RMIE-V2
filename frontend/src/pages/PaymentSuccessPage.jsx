...
const TIER_INFO = {
  founders: {
    ...
    next: [
      ...
      "Your Founders Lifetime access is active now — log in to your dashboard to get started.",
  ...
  pro: {
    ...
    next: [
      ...
      "Pro access is active now — log in to your dashboard and start building.",
      "Generate your full RMIE blueprint and begin executing your 7-day action plan today.",
    ],
  },
  elite: {
    name: "Elite",
    ...
    next: [
      ...
      "Elite access is active now — including advanced strategist guidance and financial projections.",
  ...
  default: {
    ...
    next: [
      ...
      "Generate a free business roadmap to begin building your plan.",
    ],
  },
};
