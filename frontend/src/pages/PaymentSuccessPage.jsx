...
const TIER_INFO = {
  founders: {
    ...
    next: [
      ...
      "Your full platform access is active now — dashboard, roadmap tools, and Founders benefits are unlocked.",
  ...
  pro: {
    ...
    next: [
      ...
      "Your Pro access is active now — unlimited roadmaps, outreach automation, and more.",
      "Head to your dashboard to start building your business roadmap.",
    ],
  },
  elite: {
    name: "Elite",
    ...
    next: [
      ...
      "Your Elite access — including done-with-you strategy sessions — is active now.",
