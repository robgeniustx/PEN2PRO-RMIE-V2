...
const TIER_INFO = {
  founders: {
    ...
    next: [
      ...
      "You have lifetime access — log in to your dashboard and start building now.",
  ...
  pro: {
    ...
    next: [
      ...
      "Pro access is now active — log in to your dashboard for unlimited roadmaps, outreach automation, and more.",
      "Generate your first Pro roadmap and start executing within minutes.",
    ],
  },
  elite: {
    name: "Elite",
    ...
    next: [
      ...
      "Elite access is now active — including advanced strategy tools, financial projections, and automation.",
  ...
  default: {
    ...
    next: [
      ...
      "Log in to your dashboard and start building your business roadmap.",
      "Generate a free business roadmap and start your launch plan now.",
    ],
  },
};
