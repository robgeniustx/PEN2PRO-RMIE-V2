  ...
  const submit = async (e) => {
    ...
    try {
      ...
      if (res.ok) {
        ...
        if (res.status === 409) {
          setErrorMsg("That email is already on the list. You're already in — we'll see you inside!");
          setStatus("error");
        } else {
        ...
        <div className="flex min-h-[80vh] items-center justify-center px-5 py-16">
          <div className="mx-auto w-full max-w-lg text-center">
            ...
            <p className="text-base leading-7 text-slate-400 mb-8">
              ...
              PEN2PRO is{" "}
              <strong style={{ color: "#D4A017" }}>now live</strong> — your access and pricing are locked in.
              {refParam && (
            ...
            <div className="rounded-2xl border border-[#1A2235] bg-[#0F1520] p-6 mb-8 text-left">
              ...
              <ul className="space-y-3">
                {[
                  "Your spot is confirmed — pricing locked in for founding members",
                  "Start your free roadmap right now",
                  "Upgrade to Pro, Elite, or Founders to unlock full access",
        ...
        <div className="mx-auto max-w-5xl grid gap-12 md:grid-cols-2 md:items-start">
          ...
          <div>
            ...
            <h1 className="font-display text-4xl font-black leading-tight text-white md:text-5xl">
              Now Live.<br />
              <span className="gradient-text">Founders Offer Closing Soon.</span>
            </h1>

            <p className="mt-5 text-base leading-7 text-slate-400">
              PEN2PRO is <strong className="text-white">now live</strong>. Only{" "}
              <strong className="text-white">200 founding spots</strong> exist — founding members
              lock in their pricing for life, get first access, and receive done-with-you launch support
              that won't be available after this offer closes.
            </p>

            {/* Countdown */}
            <div className="mt-8">
              <p className="mb-3 text-xs font-bold uppercase tracking-widest text-slate-500">Founders Offer Closes</p>
