          ...
          <div>
            ...
            <div className="mb-5 inline-flex items-center gap-2 rounded-full border px-4 py-2"
              ...
              <span className="text-xs font-bold uppercase tracking-widest" style={{ color: "#D4A017" }}>
                Founders Lifetime Closes August 1 — Only 200 Spots
              </span>
            </div>
            ...
            {/* Countdown */}
            <div className="mt-8">
              <p className="mb-3 text-xs font-bold uppercase tracking-widest text-slate-500">Founders Lifetime Closes In</p>
