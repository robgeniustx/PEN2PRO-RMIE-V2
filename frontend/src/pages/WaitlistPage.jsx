        ...
        <div className="flex min-h-[80vh] items-center justify-center px-5 py-16">
          <div className="mx-auto w-full max-w-lg text-center">
            ...
            <p className="text-base leading-7 text-slate-400 mb-8">
              ...
              PEN2PRO is{" "}
              <strong style={{ color: "#D4A017" }}>live now</strong> — watch for your access email.
              {refParam && (
            ...
            <div className="rounded-2xl border border-[#1A2235] bg-[#0F1520] p-6 mb-8 text-left">
              ...
              <ul className="space-y-3">
                {[
                  "Confirmation details saved — watch your inbox for access instructions",
                  "Founding members get pricing locked forever — never increases",
                  "Start your free roadmap right now while we set up your account",
          ...
          <div>
            ...
            <div className="mb-5 inline-flex items-center gap-2 rounded-full border px-4 py-2"
              ...
              <span className="text-xs font-bold uppercase tracking-widest" style={{ color: "#D4A017" }}>
                Now Live — Limited Founding Spots Remain
              </span>
            </div>

            <h1 className="font-display text-4xl font-black leading-tight text-white md:text-5xl">
              We're Live.<br />
              <span className="gradient-text">Secure Your Founding Spot.</span>
            </h1>

            <p className="mt-5 text-base leading-7 text-slate-400">
              PEN2PRO is <strong className="text-white">now live</strong> as of June 15, 2026. Founding members
              lock in their pricing for life, get full platform access, and receive done-with-you onboarding
              support available for a limited time.
            </p>

            {/* Live badge */}
            <div className="mt-8 inline-flex items-center gap-3 rounded-xl border border-[#1A2235] bg-[#0F1520] px-5 py-3">
              <span className="h-2.5 w-2.5 rounded-full bg-emerald-400 animate-pulse shrink-0" />
              <span className="text-sm font-bold text-white">PEN2PRO is officially live — June 15, 2026</span>
            </div>
