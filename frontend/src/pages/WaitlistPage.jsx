        ...
        <div className="flex min-h-[80vh] items-center justify-center px-5 py-16">
          <div className="mx-auto w-full max-w-lg text-center">
            ...
            <p className="text-base leading-7 text-slate-400 mb-8">
              ...
              You're locked in as a PEN2PRO founding member with{" "}
              <strong style={{ color: "#D4A017" }}>pricing that never increases</strong>.
              {refParam && (
            ...
            <div className="rounded-2xl border border-[#1A2235] bg-[#0F1520] p-6 mb-8 text-left">
              ...
              <ul className="space-y-3">
                {[
                  "Your spot is confirmed — we'll follow up with onboarding details",
                  "Founding members get lifetime pricing locked in — never increases",
                  "Start your free roadmap right now and see RMIE in action",
        ...
        <div className="mx-auto max-w-5xl grid gap-12 md:grid-cols-2 md:items-start">
          ...
          <div>
            ...
            <p className="mt-5 text-base leading-7 text-slate-400">
              PEN2PRO is live and accepting founding members. Lock in your pricing for life,
              get first access to every new feature, and receive done-with-you launch support
              available only during the founding period.
            </p>
