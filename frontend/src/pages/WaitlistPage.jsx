  ...
  const submit = async (e) => {
    ...
    try {
      ...
      if (res.ok) {
        ...
        if (res.status === 409) {
          setErrorMsg("That email is already on the list. You're already in!");
          setStatus("error");
        } else {
        ...
        <div className="flex min-h-[80vh] items-center justify-center px-5 py-16">
          <div className="mx-auto w-full max-w-lg text-center">
            ...
            <p className="text-base leading-7 text-slate-400 mb-8">
              ...
              Our team will follow up with next steps based on what you're most interested in.
              {refParam && (
            ...
            <div className="rounded-2xl border border-[#1A2235] bg-[#0F1520] p-6 mb-8 text-left">
              ...
              <ul className="space-y-3">
                {[
                  "Confirmation details are saved — watch your email for a follow-up",
                  "Founders Lifetime members get pricing locked in forever",
                  "Start your free roadmap right now — no need to wait",
          ...
          <div>
            ...
            <div className="mb-5 inline-flex items-center gap-2 rounded-full border px-4 py-2"
              ...
              <span className="text-xs font-bold uppercase tracking-widest" style={{ color: "#D4A017" }}>
                PEN2PRO Is Live — Limited Founding Spots Remain
              </span>
            </div>

            <h1 className="font-display text-4xl font-black leading-tight text-white md:text-5xl">
              Join the List.<br />
              <span className="gradient-text">Get First Access.</span>
            </h1>

            <p className="mt-5 text-base leading-7 text-slate-400">
              PEN2PRO is live now. Join the waitlist to hear about new features first, lock in
              Founders Lifetime pricing before spots run out, and get done-with-you launch support.
            </p>
