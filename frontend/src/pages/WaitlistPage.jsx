              ...
              <form onSubmit={submit} className="space-y-4">
                ...
                <div>
                  ...
                  <textarea name="business_idea" value={form.business_idea} onChange={handle}
                    ...
                    rows={3} className="w-full rounded-xl border border-[#1A2235] bg-[#080C14] px-4 py-3 text-sm text-white placeholder-slate-600 resize-none focus:border-[#D4A017] focus:outline-none" />
                </div>
