      ...
      <section className="relative overflow-hidden px-5 pt-20 pb-28 md:pt-28 md:pb-36 text-center">
        ...
        <div className="relative mx-auto max-w-4xl">
          ...
          <div className="mt-14 flex flex-col items-center">
            <p className="mb-4 text-xs font-bold uppercase tracking-widest text-slate-500">Trusted by builders across the country</p>
            <div className="flex flex-wrap justify-center gap-5">
              {["Veterans", "Returning Citizens", "Entrepreneurs", "Small Business Owners", "Creators"].map((label) => (
                <span key={label} className="rounded-full border border-[#1A2235] bg-[#0F1520] px-4 py-1.5 text-xs font-semibold text-slate-400">{label}</span>
              ))}
            </div>
            <p className="mt-4 text-xs text-slate-600">Founders pricing locks in when you join the waitlist today</p>
          </div>
        </div>
      </section>
