...
// Founders Lifetime deadline — August 1, 2026
const FOUNDERS_DEADLINE = "2026-08-01T00:00:00Z";
...
export default function HomePage() {
  const cd = useCountdown(FOUNDERS_DEADLINE);
      ...
      <section className="relative overflow-hidden px-5 pt-20 pb-28 md:pt-28 md:pb-36 text-center">
        ...
        <div className="relative mx-auto max-w-4xl">
          <div className="animate-fade-up mb-6 inline-flex items-center gap-2 rounded-full border px-4 py-2" style={{ borderColor: 'rgba(212,160,23,0.3)', background: 'rgba(212,160,23,0.08)' }}>
            ...
            <span className="text-xs font-bold uppercase tracking-widest" style={{ color: '#D4A017' }}>Now Live — Early Access Open · Founders Closing Aug 1</span>
          </div>
          ...
          {/* Founders Deadline Countdown */}
          <div className="mt-14 flex flex-col items-center">
            <p className="mb-4 text-xs font-bold uppercase tracking-widest text-slate-500">Founders Lifetime Closing — August 1, 2026 · Only 200 Spots</p>
            ...
            <p className="mt-3 text-xs text-slate-600">Lock in Founders Lifetime pricing before August 1 — $1,899 one-time, never recurring</p>
          </div>
        </div>
      </section>
