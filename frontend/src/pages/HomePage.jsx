    ...
    <div className="min-h-screen bg-[#080C14]">
      ...
      <section className="relative overflow-hidden px-5 pt-20 pb-28 md:pt-28 md:pb-36 text-center">
        ...
        <div className="relative mx-auto max-w-4xl">
          <div className="animate-fade-up mb-6 inline-flex items-center gap-2 rounded-full border px-4 py-2" style={{ borderColor: 'rgba(212,160,23,0.3)', background: 'rgba(212,160,23,0.08)' }}>
            ...
            <span className="text-xs font-bold uppercase tracking-widest" style={{ color: '#D4A017' }}>Now Live — Founding Member Pricing Available</span>
          </div>
          ...
          <div className="mt-14 rounded-xl border border-[#1A2235] bg-[#0F1520] px-6 py-4 flex flex-col sm:flex-row items-center gap-4 sm:gap-6">
            <div className="flex items-center gap-2">
              <span className="h-2.5 w-2.5 rounded-full bg-emerald-400 animate-pulse" />
              <p className="text-xs font-bold uppercase tracking-widest text-emerald-400">Platform Live</p>
            </div>
            <p className="text-sm text-slate-400 text-center sm:text-left">
              Founding Member pricing is still available. <span style={{ color: '#D4A017' }} className="font-semibold">200 spots only.</span> Lock in lifetime access before the window closes.
            </p>
            <Link to="/founders" className="shrink-0 rounded-xl px-5 py-2 text-xs font-black text-[#080C14] btn-gold whitespace-nowrap">
              Claim Your Spot →
            </Link>
          </div>
        </div>
      ...
      <section className="border-y border-[#1A2235] bg-[#0F1520] px-5 py-8">
        <div className="mx-auto max-w-5xl grid grid-cols-2 gap-6 md:grid-cols-4 text-center">
          {[["2,847+","Roadmaps Generated"],["$0","Required to Start"],["7 Days","To First Plan"],["200","Founder Spots Left"]].map(([v,l]) => (
            <div key={l}>
