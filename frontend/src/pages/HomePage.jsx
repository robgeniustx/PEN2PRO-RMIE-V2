      ...
      <section className="relative overflow-hidden px-5 pt-20 pb-28 md:pt-28 md:pb-36 text-center">
        ...
        <div className="relative mx-auto max-w-4xl">
          ...
          <div className="mt-14 flex flex-col items-center">
            <div className="inline-flex items-center gap-3 rounded-2xl border px-6 py-4" style={{ borderColor: 'rgba(212,160,23,0.3)', background: 'rgba(212,160,23,0.06)' }}>
              <span className="h-3 w-3 rounded-full bg-emerald-400 animate-pulse shrink-0" />
              <span className="text-sm font-bold text-white">Platform is Live — Founding Member Pricing Still Available</span>
            </div>
            <p className="mt-3 text-xs text-slate-600">Founders pricing locks in when you join today</p>
          </div>
        </div>
      </section>
