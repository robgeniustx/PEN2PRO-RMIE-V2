      ...
      <section className="relative overflow-hidden px-5 pt-20 pb-28 md:pt-28 md:pb-36 text-center">
        ...
        <div className="relative mx-auto max-w-4xl">
          ...
          <div className="mt-14 flex flex-col items-center">
            <div className="rounded-2xl border border-[#1A2235] bg-[#0F1520] px-8 py-5 text-center">
              <p className="text-xs font-bold uppercase tracking-widest text-emerald-400 mb-2">⚡ Platform is Live</p>
              <p className="text-sm text-slate-400 max-w-sm">
                PEN2PRO launched June 15, 2026. Start your free roadmap now or join the waitlist for Pro and Elite early access.
              </p>
              <div className="mt-4 flex flex-col gap-2 sm:flex-row sm:justify-center">
                <Link to="/starter" className="rounded-xl px-5 py-2.5 text-xs font-black text-[#080C14] btn-gold">Start Free Roadmap</Link>
                <Link to="/waitlist" className="rounded-xl border border-[#1A2235] px-5 py-2.5 text-xs font-semibold text-slate-300 hover:text-white transition-colors">Join Waitlist</Link>
              </div>
            </div>
          </div>
        </div>
