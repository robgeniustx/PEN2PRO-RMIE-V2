      ...
      <section className="relative overflow-hidden px-5 pt-20 pb-28 md:pt-28 md:pb-36 text-center">
        ...
        <div className="relative mx-auto max-w-4xl">
          <div className="animate-fade-up mb-6 inline-flex items-center gap-2 rounded-full border px-4 py-2" style={{ borderColor: 'rgba(212,160,23,0.3)', background: 'rgba(212,160,23,0.08)' }}>
            ...
            <span className="text-xs font-bold uppercase tracking-widest" style={{ color: '#D4A017' }}>Now Live — PEN2PRO Early Access Open</span>
          </div>
          ...
          <div className="mt-14 flex flex-col items-center">
            <div className="rounded-2xl border border-[#1A2235] px-8 py-5 text-center" style={{ background: 'rgba(212,160,23,0.06)' }}>
              <p className="text-xs font-bold uppercase tracking-widest text-slate-500 mb-2">Official Launch — June 15, 2026</p>
              <p className="font-display text-2xl font-black" style={{ color: '#D4A017' }}>We're Live.</p>
              <p className="mt-2 text-sm text-slate-500">Founding member pricing is still available — limited to 200 spots.</p>
            </div>
          </div>
        </div>
      </section>
