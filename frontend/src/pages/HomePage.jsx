...
// Founders closing date: Aug 1, 2026
const FOUNDERS_CLOSE = "2026-08-01T00:00:00Z";
...
export default function HomePage() {
  const cd = useCountdown(FOUNDERS_CLOSE);
      ...
      <section className="relative overflow-hidden px-5 pt-20 pb-28 md:pt-28 md:pb-36 text-center">
        ...
        <div className="relative mx-auto max-w-4xl">
          ...
          <div className="mt-14 flex flex-col items-center">
            <p className="mb-4 text-xs font-bold uppercase tracking-widest text-slate-500">Founders Lifetime Offer Closes — August 1, 2026 · Only 200 Spots</p>
            ...
            <p className="mt-3 text-xs text-slate-600">Lock in Founders pricing before it's gone forever</p>
          </div>
        </div>
      </section>
