      ...
      <section className="relative overflow-hidden px-5 pt-20 pb-28 md:pt-28 md:pb-36 text-center">
        ...
        <div className="relative mx-auto max-w-4xl">
          ...
          <div className="mt-14 flex flex-wrap items-center justify-center gap-3">
            {["Free Roadmap → /starter", "Pro Plan → /pro", "Elite Plan → /elite", "Founders Lifetime → /founders"].map((badge) => {
              const [label, path] = badge.split(" → ");
              return (
                <a key={path} href={path} className="rounded-full border border-[#1A2235] px-4 py-1.5 text-xs font-semibold text-slate-400 hover:text-yellow-400 hover:border-yellow-500/40 transition-colors">
                  {label}
                </a>
              );
            })}
