    ...
    <div className="min-h-screen bg-[#080C14]">
        ...
        <div className="relative mx-auto max-w-4xl">
          ...
          <div className="mt-14 flex flex-col items-center gap-3">
            <div className="flex items-center gap-3 rounded-2xl border border-emerald-500/30 bg-emerald-500/10 px-6 py-3">
              ...
              <span className="text-sm font-bold text-emerald-400">PEN2PRO is Live — Roadmaps Available Now</span>
            </div>
      ...
      <section className="border-y border-[#1A2235] bg-[#0F1520] px-5 py-8">
        <div className="mx-auto max-w-5xl grid grid-cols-2 gap-6 md:grid-cols-4 text-center">
          {[["2,847+","Roadmaps Generated"],["$0","Required to Start"],["7 Days","To First Plan"],["Now Live","Access Available"]].map(([v,l]) => (
            <div key={l}>
