    ...
    <div className="min-h-screen bg-[#080C14]">
      ...
      <section className="relative overflow-hidden px-5 pt-20 pb-28 md:pt-28 md:pb-36 text-center">
        ...
        <div className="relative mx-auto max-w-4xl">
          <div className="animate-fade-up mb-6 inline-flex items-center gap-2 rounded-full border px-4 py-2" style={{ borderColor: 'rgba(212,160,23,0.3)', background: 'rgba(212,160,23,0.08)' }}>
            ...
            <span className="text-xs font-bold uppercase tracking-widest" style={{ color: '#D4A017' }}>Now Live — Build Your Business Roadmap Today</span>
          </div>
          ...
          <div className="mt-14 flex flex-col items-center">
            <p className="mb-4 text-xs font-bold uppercase tracking-widest text-slate-500">Platform Status</p>
            <div className="flex items-center gap-6 rounded-2xl border border-[#1A2235] bg-[#0F1520] px-8 py-5">
              ...
              <div className="text-center">
                <p className="font-display text-xl font-black" style={{ color: '#D4A017' }}>2,847+</p>
                <p className="text-xs text-slate-500">Roadmaps Built</p>
              </div>
              <div className="h-6 w-px bg-[#1A2235]" />
              <div className="text-center">
                <p className="font-display text-xl font-black text-white">200</p>
                <p className="text-xs text-slate-500">Founders Spots</p>
              </div>
            </div>
            <p className="mt-3 text-xs text-slate-600">Founding member pricing is still available — limited spots remaining</p>
          </div>
        </div>
      </section>
      ...
      <section className="border-y border-[#1A2235] bg-[#0F1520] px-5 py-8">
        <div className="mx-auto max-w-5xl grid grid-cols-2 gap-6 md:grid-cols-4 text-center">
          {[["2,847+","Roadmaps Generated"],["$0","Required to Start"],["7 Days","To First Plan"],["🟢 Live","Platform Status"]].map(([v,l]) => (
            <div key={l}>
