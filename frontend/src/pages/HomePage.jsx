    ...
    <div className="min-h-screen bg-[#080C14]">
      ...
      <section className="relative overflow-hidden px-5 pt-20 pb-28 md:pt-28 md:pb-36 text-center">
        ...
        <div className="relative mx-auto max-w-4xl">
          <div className="animate-fade-up mb-6 inline-flex items-center gap-2 rounded-full border px-4 py-2" style={{ borderColor: 'rgba(212,160,23,0.3)', background: 'rgba(212,160,23,0.08)' }}>
            ...
            <span className="text-xs font-bold uppercase tracking-widest" style={{ color: '#D4A017' }}>Now Live — Early Access Open · Founders Spots Limited</span>
          </div>
          ...
          {/* Early Access Banner */}
          <div className="mt-14 mx-auto max-w-2xl rounded-2xl border px-6 py-5 text-center" style={{ borderColor: 'rgba(212,160,23,0.25)', background: 'rgba(212,160,23,0.05)' }}>
            <p className="text-xs font-bold uppercase tracking-widest mb-2" style={{ color: '#D4A017' }}>Early Access — Founders Lifetime · Only 200 Spots</p>
            <p className="text-sm text-slate-400">Lock in lifetime access at the founding price before spots fill. Pro and Elite subscriptions open now.</p>
            <div className="mt-4 flex flex-col items-center gap-2 sm:flex-row sm:justify-center">
              <Link to="/founders" className="rounded-xl px-5 py-2.5 text-sm font-black text-[#080C14] btn-gold">Claim Founders Lifetime →</Link>
              <Link to="/pricing" className="rounded-xl border border-[#1A2235] px-5 py-2.5 text-sm font-semibold text-slate-400 hover:text-white transition-colors">View All Plans</Link>
            </div>
          </div>
        </div>
      </section>
      ...
      <section className="border-y border-[#1A2235] bg-[#0F1520] px-5 py-8">
        <div className="mx-auto max-w-5xl grid grid-cols-2 gap-6 md:grid-cols-4 text-center">
          {[["2,847+","Roadmaps Generated"],["$0","Required to Start"],["7 Days","To First Plan"],["Now Live","Early Access"]].map(([v,l]) => (
            <div key={l}>
