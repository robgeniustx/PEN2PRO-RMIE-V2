    ...
    <div className="min-h-screen bg-[#080C14]">
      ...
      <section className="relative overflow-hidden px-5 pt-20 pb-28 md:pt-28 md:pb-36 text-center">
        ...
        <div className="relative mx-auto max-w-4xl">
          <div className="animate-fade-up mb-6 inline-flex items-center gap-2 rounded-full border px-4 py-2" style={{ borderColor: 'rgba(212,160,23,0.3)', background: 'rgba(212,160,23,0.08)' }}>
            ...
            <span className="text-xs font-bold uppercase tracking-widest" style={{ color: '#D4A017' }}>Now Live — Founders Lifetime Access Available</span>
          </div>
          ...
          <div className="mt-14 flex flex-col items-center">
            <p className="mb-4 text-xs font-bold uppercase tracking-widest text-slate-500">Founders Lifetime Access — Limited Availability</p>
            <div className="flex items-center gap-5 rounded-2xl border px-8 py-5" style={{ borderColor: 'rgba(212,160,23,0.35)', background: 'rgba(212,160,23,0.06)' }}>
              <span className="font-display text-5xl font-black" style={{ color: '#D4A017' }}>200</span>
              <div className="text-left">
                <p className="text-base font-black text-white">Founders Spots Available</p>
                <p className="text-xs text-slate-400 mt-0.5">Lifetime access · All features unlocked · Lock in today's pricing forever</p>
              </div>
            </div>
            <Link to="/founders" className="mt-4 text-sm font-semibold hover:opacity-80 transition" style={{ color: '#D4A017' }}>
      ...
      <section className="border-y border-[#1A2235] bg-[#0F1520] px-5 py-8">
        <div className="mx-auto max-w-5xl grid grid-cols-2 gap-6 md:grid-cols-4 text-center">
          {[["2,847+","Roadmaps Generated"],["$0","Required to Start"],["7 Days","To First Plan"],["200","Founders Spots Left"]].map(([v,l]) => (
            <div key={l}>
