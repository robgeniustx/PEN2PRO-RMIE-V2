      ...
      <section className="relative overflow-hidden px-5 pt-20 pb-28 md:pt-28 md:pb-36 text-center">
        ...
        <div className="relative mx-auto max-w-4xl">
          <div className="animate-fade-up mb-6 inline-flex items-center gap-2 rounded-full border px-4 py-2" style={{ borderColor: 'rgba(212,160,23,0.3)', background: 'rgba(212,160,23,0.08)' }}>
            ...
            <span className="text-xs font-bold uppercase tracking-widest" style={{ color: '#D4A017' }}>Now Live — AI-Powered Business Roadmaps, Free to Start</span>
          </div>
          ...
          <div className="mt-14 flex flex-col items-center">
            <div className="flex flex-wrap items-center justify-center gap-6 rounded-2xl border border-[#1A2235] bg-[#0F1520] px-8 py-5">
              {[["✓","Platform Live","June 2026"],["✓","Free Roadmaps","No credit card"],["✓","Founders Access","Limited spots"],["✓","Waitlist Open","Lock pricing now"]].map(([icon, title, sub]) => (
                <div key={title} className="flex items-center gap-2.5">
                  <span className="text-sm font-black text-emerald-400">{icon}</span>
                  <div>
