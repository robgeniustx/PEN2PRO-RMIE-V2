    ...
    <div className="min-h-screen bg-[#080C14]">
      ...
      <section className="relative overflow-hidden px-5 pt-20 pb-28 md:pt-28 md:pb-36 text-center">
        ...
        <div className="relative mx-auto max-w-4xl">
          <div className="animate-fade-up mb-6 inline-flex items-center gap-2 rounded-full border px-4 py-2" style={{ borderColor: 'rgba(212,160,23,0.3)', background: 'rgba(212,160,23,0.08)' }}>
            ...
            <span className="text-xs font-bold uppercase tracking-widest" style={{ color: '#D4A017' }}>Now Live — Enrollment Open · Limited Founders Spots</span>
          </div>
          ...
          <div className="mt-14 flex flex-col items-center">
            <div className="flex flex-wrap items-center justify-center gap-6 rounded-2xl border border-[#D4A017]/20 bg-[#D4A017]/05 px-8 py-5">
              <div className="flex items-center gap-2 text-sm font-semibold text-slate-300">
                <span className="text-[#D4A017]">⚡</span> Platform is live
              </div>
              <div className="h-4 w-px bg-[#1A2235]" />
              <div className="flex items-center gap-2 text-sm font-semibold text-slate-300">
                <span className="text-emerald-400">●</span> Free roadmaps available now
              </div>
              <div className="h-4 w-px bg-[#1A2235]" />
              <div className="flex items-center gap-2 text-sm font-semibold text-[#D4A017]">
                🏆 Founders spots limited — claim yours
              </div>
            </div>
          </div>
        </div>
      ...
      <section className="border-y border-[#1A2235] bg-[#0F1520] px-5 py-8">
        <div className="mx-auto max-w-5xl grid grid-cols-2 gap-6 md:grid-cols-4 text-center">
          {[["2,847+","Roadmaps Generated"],["$0","Required to Start"],["7 Days","To First Plan"],["Now Live","Enrollment Open"]].map(([v,l]) => (
            <div key={l}>
