      ...
      <section className="relative overflow-hidden px-5 pt-20 pb-28 md:pt-28 md:pb-36 text-center">
        ...
        <div className="relative mx-auto max-w-4xl">
          ...
          <div className="mt-14 flex flex-col items-center">
            <p className="mb-4 text-xs font-bold uppercase tracking-widest text-slate-500">Founders Lifetime Closing — August 1, 2026</p>
            ...
            <p className="mt-3 text-xs text-slate-600">Only 200 Founders spots. Pricing locks in permanently — no renewals.</p>
          </div>
        </div>
      </section>
