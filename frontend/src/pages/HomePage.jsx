    ...
    <div className="min-h-screen bg-[#080C14]">
      ...
      <section className="relative overflow-hidden px-5 pt-20 pb-28 md:pt-28 md:pb-36 text-center">
        ...
        <div className="relative mx-auto max-w-4xl">
          ...
          {/* Founders Price Lock Urgency */}
          <div className="mt-14 flex flex-col items-center">
            <p className="mb-4 text-xs font-bold uppercase tracking-widest text-slate-500">Founders Lifetime — Limited to 200 Spots</p>
            ...
            <p className="mt-3 text-xs text-slate-600">Founders pricing locks in before September 1 — price increases after</p>
          </div>
        </div>
      </section>
