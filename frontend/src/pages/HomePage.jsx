    ...
    <div className="min-h-screen bg-[#080C14]">
      ...
      <section className="relative overflow-hidden px-5 pt-20 pb-28 md:pt-28 md:pb-36 text-center">
        ...
        <div className="relative mx-auto max-w-4xl">
          <div className="animate-fade-up mb-6 inline-flex items-center gap-2 rounded-full border px-4 py-2" style={{ borderColor: 'rgba(212,160,23,0.3)', background: 'rgba(212,160,23,0.08)' }}>
            ...
            <span className="text-xs font-bold uppercase tracking-widest" style={{ color: '#D4A017' }}>Now Live — June 15, 2026 · Founders Spots Are Open</span>
          </div>
          ...
          {/* Founders Urgency — replaces expired countdown */}
          <div className="mt-14 flex flex-col items-center">
            <div className="w-full max-w-md rounded-2xl border px-8 py-6 text-center" style={{ borderColor: 'rgba(212,160,23,0.35)', background: 'rgba(212,160,23,0.05)' }}>
              <p className="mb-1 text-xs font-black uppercase tracking-widest" style={{ color: '#D4A017' }}>Founders Lifetime — Only 200 Spots</p>
              <p className="font-display text-3xl font-black text-white">$1,899 — One Time</p>
              <p className="mt-2 text-sm text-slate-400">Lifetime access to every PEN2PRO tool. This price will not return once spots are gone.</p>
              <Link to="/pricing" className="mt-5 inline-block rounded-xl px-7 py-3 text-sm font-black text-[#080C14] btn-gold">
                Claim Your Founders Spot →
              </Link>
            </div>
            <p className="mt-3 text-xs text-slate-600">After 200 spots fill — Pro starts at $249/mo</p>
          </div>
        </div>
      </section>
      ...
      <section className="border-y border-[#1A2235] bg-[#0F1520] px-5 py-8">
        <div className="mx-auto max-w-5xl grid grid-cols-2 gap-6 md:grid-cols-4 text-center">
          {[["2,847+","Roadmaps Generated"],["$0","Required to Start"],["7 Days","To First Plan"],["LIVE","June 15, 2026"]].map(([v,l]) => (
            <div key={l}>
