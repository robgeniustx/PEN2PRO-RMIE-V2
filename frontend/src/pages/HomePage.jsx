    ...
    <div className="min-h-screen bg-[#080C14]">
      ...
      <section className="relative overflow-hidden px-5 pt-20 pb-28 md:pt-28 md:pb-36 text-center">
        ...
        <div className="relative mx-auto max-w-4xl">
          <div className="animate-fade-up mb-6 inline-flex items-center gap-2 rounded-full border px-4 py-2" style={{ borderColor: 'rgba(5,150,105,0.4)', background: 'rgba(5,150,105,0.08)' }}>
            <span className="h-2 w-2 rounded-full bg-emerald-400 animate-pulse" />
            <span className="text-xs font-bold uppercase tracking-widest text-emerald-400">Now Live — Founders Lifetime Access Available</span>
          </div>
          ...
          <div className="mt-14 flex flex-col items-center">
            <div className="rounded-2xl border px-8 py-5 text-center" style={{ borderColor: 'rgba(212,160,23,0.3)', background: 'rgba(212,160,23,0.06)' }}>
              <p className="text-xs font-bold uppercase tracking-widest mb-2" style={{ color: '#D4A017' }}>Legacy Founders — Limited Spots</p>
              <p className="text-white font-black text-xl">$1,899 Lifetime Access</p>
              <p className="mt-1 text-xs text-slate-500">One payment. Full platform for life. Price increases after founding round closes.</p>
            </div>
          </div>
        </div>
      </section>
