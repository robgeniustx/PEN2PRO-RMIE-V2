      ...
      <section className="relative overflow-hidden px-5 pt-20 pb-28 md:pt-28 md:pb-36 text-center">
        ...
        <div className="relative mx-auto max-w-4xl">
          <div className="animate-fade-up mb-6 inline-flex items-center gap-2 rounded-full border px-4 py-2" style={{ borderColor: 'rgba(212,160,23,0.3)', background: 'rgba(212,160,23,0.08)' }}>
            ...
            <span className="text-xs font-bold uppercase tracking-widest" style={{ color: '#D4A017' }}>Platform Now Live — Free Roadmap Available Today</span>
          </div>
          ...
          <div className="mt-14 flex flex-col items-center">
            <div className="rounded-2xl border px-8 py-5 text-center" style={{ borderColor: 'rgba(212,160,23,0.3)', background: 'rgba(212,160,23,0.06)' }}>
              <p className="text-xs font-bold uppercase tracking-widest text-slate-500 mb-2">Platform Status</p>
              <p className="font-display text-2xl font-black" style={{ color: '#D4A017' }}>🟢 Open &amp; Live</p>
              <p className="mt-2 text-sm text-slate-400">Founders Lifetime pricing available for a limited time — <span className="font-bold text-white">200 spots only</span></p>
            </div>
          </div>
        </div>
      </section>
