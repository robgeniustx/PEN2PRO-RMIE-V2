      ...
      <section className="relative overflow-hidden px-5 pt-20 pb-28 md:pt-28 md:pb-36 text-center">
        ...
        <div className="relative mx-auto max-w-4xl">
          <div className="animate-fade-up mb-6 inline-flex items-center gap-2 rounded-full border px-4 py-2" style={{ borderColor: 'rgba(212,160,23,0.3)', background: 'rgba(212,160,23,0.08)' }}>
            ...
            <span className="text-xs font-bold uppercase tracking-widest" style={{ color: '#D4A017' }}>Now Live — Build Your Free Business Roadmap Today</span>
          </div>
          ...
          <div className="mt-14 flex flex-col items-center">
            <div className="flex items-center gap-3 rounded-2xl border px-8 py-4" style={{ borderColor: 'rgba(212,160,23,0.35)', background: 'rgba(212,160,23,0.07)' }}>
              <span className="h-3 w-3 rounded-full bg-emerald-400 animate-pulse shrink-0" />
              <span className="font-display text-lg font-black" style={{ color: '#D4A017' }}>PEN2PRO IS LIVE</span>
              <span className="h-3 w-3 rounded-full bg-emerald-400 animate-pulse shrink-0" />
            </div>
