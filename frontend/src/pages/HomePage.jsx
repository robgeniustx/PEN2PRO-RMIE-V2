      ...
      <section className="relative overflow-hidden px-5 pt-20 pb-28 md:pt-28 md:pb-36 text-center">
        ...
        <div className="relative mx-auto max-w-4xl">
          <div className="animate-fade-up mb-6 inline-flex items-center gap-2 rounded-full border px-4 py-2" style={{ borderColor: 'rgba(212,160,23,0.3)', background: 'rgba(212,160,23,0.08)' }}>
            ...
            <span className="text-xs font-bold uppercase tracking-widest" style={{ color: '#D4A017' }}>Now Live — Start Your Free Roadmap Today</span>
          </div>
          ...
          <div className="mt-14 flex flex-col items-center">
            ...
            <div className="flex items-center gap-4 rounded-2xl border border-[#1A2235] bg-[#0F1520] px-8 py-4">
              <div className="flex items-center gap-2">
                <span className="h-3 w-3 rounded-full bg-emerald-400 animate-pulse" />
                <span className="text-sm font-bold text-white">Live &amp; Accepting Users</span>
              </div>
              <span className="h-4 w-px bg-[#1A2235]" />
              <span className="text-sm text-slate-400">Free Forever · No Credit Card</span>
            </div>
            <p className="mt-3 text-xs text-slate-600">Founders lifetime pricing still available — limited spots remaining</p>
          </div>
        </div>
      </section>
