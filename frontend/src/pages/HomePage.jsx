          ...
          <div className="mt-14 flex flex-col items-center">
            <div className="inline-flex items-center gap-3 rounded-2xl border border-emerald-500/30 bg-emerald-500/10 px-6 py-4">
              ...
              <div className="text-left">
                <p className="text-sm font-black text-emerald-400 uppercase tracking-wide">Platform Now Live</p>
                <p className="text-xs text-slate-400 mt-0.5">Founders Lifetime access — limited spots remaining</p>
              </div>
            </div>
          </div>
        </div>
