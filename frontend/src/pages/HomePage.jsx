    ...
    <div className="min-h-screen bg-[#080C14]">
      ...
      <section className="relative overflow-hidden px-5 pt-20 pb-28 md:pt-28 md:pb-36 text-center">
        ...
        <div className="relative mx-auto max-w-4xl">
          ...
          <div className="mt-14 flex flex-col items-center">
            <div className="flex items-center gap-3 rounded-2xl border border-emerald-500/30 bg-emerald-500/10 px-8 py-4">
              <span className="h-3 w-3 rounded-full bg-emerald-400 animate-pulse" />
              <span className="font-display text-lg font-black text-white">PEN2PRO is Now Live</span>
              <span className="h-3 w-3 rounded-full bg-emerald-400 animate-pulse" />
            </div>
            <p className="mt-3 text-xs text-slate-600">Start free today. Upgrade to Pro or Elite when you're ready.</p>
          </div>
        </div>
      </section>
      ...
      <section className="border-y border-[#1A2235] bg-[#0F1520] px-5 py-8">
        <div className="mx-auto max-w-5xl grid grid-cols-2 gap-6 md:grid-cols-4 text-center">
          {[["2,847+","Roadmaps Generated"],["$0","Required to Start"],["7 Days","To First Plan"],["Live Now","Platform Active"]].map(([v,l]) => (
            <div key={l}>
