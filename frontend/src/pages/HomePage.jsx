    ...
    <div className="min-h-screen bg-[#080C14]">
      ...
      <section className="relative overflow-hidden px-5 pt-20 pb-28 md:pt-28 md:pb-36 text-center">
        ...
        <div className="relative mx-auto max-w-4xl">
          ...
          <div className="mt-14 flex flex-col items-center">
            <div className="rounded-2xl border px-8 py-5 text-center max-w-lg" style={{ borderColor: 'rgba(212,160,23,0.25)', background: 'rgba(212,160,23,0.06)' }}>
              <p className="text-xs font-bold uppercase tracking-widest text-slate-500 mb-2">PEN2PRO is Now Live</p>
              <p className="text-lg font-black text-white mb-1">
                Start Free. Upgrade When Ready.
              </p>
              <p className="text-sm text-slate-400">Build your business roadmap today — no credit card, no fluff, no excuses.</p>
            </div>
          </div>
        </div>
      </section>
      ...
      <section className="border-y border-[#1A2235] bg-[#0F1520] px-5 py-8">
        <div className="mx-auto max-w-5xl grid grid-cols-2 gap-6 md:grid-cols-4 text-center">
          {[["2,847+","Roadmaps Generated"],["$0","Required to Start"],["7 Days","To First Plan"],["Now Live","Platform Ready"]].map(([v,l]) => (
            <div key={l}>
