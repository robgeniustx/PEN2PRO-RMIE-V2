      ...
      <section className="relative overflow-hidden px-5 pt-20 pb-28 md:pt-28 md:pb-36 text-center">
        ...
        <div className="relative mx-auto max-w-4xl">
          ...
          <div className="mt-12 flex flex-wrap items-center justify-center gap-6">
            {[
              ["2,847+", "Roadmaps Generated"],
              ["$0", "To Get Started"],
              ["5 min", "Avg. Build Time"],
            ].map(([v, l]) => (
              <div key={l} className="flex items-center gap-2">
                <span className="font-display text-xl font-black" style={{ color: '#D4A017' }}>{v}</span>
                <span className="text-xs text-slate-500 uppercase tracking-wide">{l}</span>
              </div>
            ))}
          </div>
        </div>
