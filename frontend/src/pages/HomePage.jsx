      ...
      <section className="relative overflow-hidden px-5 pt-20 pb-28 md:pt-28 md:pb-36 text-center">
        ...
        <div className="relative mx-auto max-w-4xl">
          <div className="animate-fade-up mb-6 inline-flex items-center gap-2 rounded-full border px-4 py-2" style={{ borderColor: 'rgba(212,160,23,0.3)', background: 'rgba(212,160,23,0.08)' }}>
            ...
            <span className="text-xs font-bold uppercase tracking-widest" style={{ color: '#D4A017' }}>Now Live — Founders Pricing Available</span>
          </div>
          ...
          <div className="mt-14 flex flex-col items-center">
            <div className="rounded-2xl border px-8 py-5 text-center max-w-md" style={{ borderColor: 'rgba(212,160,23,0.3)', background: 'rgba(212,160,23,0.06)' }}>
              <p className="text-xs font-bold uppercase tracking-widest mb-2" style={{ color: '#D4A017' }}>Founders Lifetime — Limited Spots</p>
              <p className="text-2xl font-black text-white">$1,899 <span className="text-base font-medium text-slate-400">one time</span></p>
              <p className="mt-2 text-xs text-slate-500">Lifetime access · Everything in Elite · P2P Command Center · 200 spots only</p>
              <Link to="/founders" className="mt-4 inline-block rounded-xl px-6 py-2.5 text-sm font-black text-[#080C14] btn-gold">
