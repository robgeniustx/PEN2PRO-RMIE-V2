    ...
    <div className="min-h-screen bg-[#080C14]">
      ...
      <section className="relative overflow-hidden px-5 pt-20 pb-28 md:pt-28 md:pb-36 text-center">
        ...
        <div className="relative mx-auto max-w-4xl">
          <div className="animate-fade-up mb-6 inline-flex items-center gap-2 rounded-full border px-4 py-2" style={{ borderColor: 'rgba(212,160,23,0.3)', background: 'rgba(212,160,23,0.08)' }}>
            ...
            <span className="text-xs font-bold uppercase tracking-widest" style={{ color: '#D4A017' }}>Now Open — Free Roadmap Available Today</span>
          </div>
          ...
          {/* Live platform trust bar */}
          <div className="mt-14 flex flex-col items-center">
            <div className="flex flex-wrap items-center justify-center gap-5 rounded-2xl border border-[#1A2235] bg-[#0F1520] px-8 py-5">
              ...
              <span className="hidden sm:block text-slate-700">|</span>
              <span className="text-xs text-slate-500 font-semibold">Free to start — no credit card</span>
              <span className="hidden sm:block text-slate-700">|</span>
              <span className="text-xs font-bold uppercase tracking-widest" style={{ color: '#D4A017' }}>Founders pricing still available</span>
            </div>
          </div>
        </div>
      </section>
      ...
      <section className="border-y border-[#1A2235] bg-[#0F1520] px-5 py-8">
        <div className="mx-auto max-w-5xl grid grid-cols-2 gap-6 md:grid-cols-4 text-center">
          {[["2,847+","Roadmaps Generated"],["$0","Required to Start"],["< 5 Min","Roadmap Ready"],["Free Forever","No Credit Card"]].map(([v,l]) => (
            <div key={l}>
