    ...
    <div className="min-h-screen bg-[#080C14]">
      ...
      <section className="relative overflow-hidden px-5 pt-20 pb-28 md:pt-28 md:pb-36 text-center">
        ...
        <div className="relative mx-auto max-w-4xl">
          <div className="animate-fade-up mb-6 inline-flex items-center gap-2 rounded-full border px-4 py-2" style={{ borderColor: 'rgba(0,201,177,0.35)', background: 'rgba(0,201,177,0.08)' }}>
            <span className="h-2 w-2 rounded-full bg-emerald-400 animate-pulse" />
            <span className="text-xs font-bold uppercase tracking-widest" style={{ color: '#00C9B1' }}>PEN2PRO Is Now Live — Join 2,847+ Builders</span>
          </div>
          ...
          <div className="mt-14 flex flex-wrap items-center justify-center gap-6">
            {[
              ...
              { icon: "⚡", text: "Roadmap ready in under 5 minutes" },
              { icon: "🔒", text: "Founders pricing — limited spots" },
            ].map((item) => (
              <div key={item.text} className="flex items-center gap-2 text-sm text-slate-500">
                <span className="font-bold" style={{ color: '#00C9B1' }}>{item.icon}</span>
                {item.text}
              </div>
            ))}
          </div>
