    ...
    <div className="min-h-screen bg-[#080C14]">
      ...
      <section className="relative overflow-hidden px-5 pt-20 pb-28 md:pt-28 md:pb-36 text-center">
        ...
        <div className="relative mx-auto max-w-4xl">
          <div className="animate-fade-up mb-6 inline-flex items-center gap-2 rounded-full border px-4 py-2" style={{ borderColor: 'rgba(212,160,23,0.3)', background: 'rgba(212,160,23,0.08)' }}>
            ...
            <span className="text-xs font-bold uppercase tracking-widest" style={{ color: '#D4A017' }}>Now Live — 200 Founders Spots Available</span>
          </div>
          ...
          {/* Live status + founders urgency */}
          <div className="mt-14 flex flex-col items-center">
            <div className="flex items-center gap-3 rounded-2xl border border-emerald-500/30 bg-emerald-900/20 px-6 py-4">
              <span className="h-3 w-3 rounded-full bg-emerald-400 animate-pulse shrink-0" />
              <div className="text-left">
                <p className="text-sm font-black text-emerald-400">PEN2PRO Is Now Live</p>
                <p className="text-xs text-slate-500 mt-0.5">Founding spots are limited — lock in lifetime pricing before they're gone</p>
              </div>
            </div>
            <p className="mt-4 text-xs text-slate-600">No credit card required · Free roadmap in under 5 minutes</p>
          </div>
      ...
      <section className="border-y border-[#1A2235] bg-[#0F1520] px-5 py-8">
        <div className="mx-auto max-w-5xl grid grid-cols-2 gap-6 md:grid-cols-4 text-center">
          {[["2,847+","Roadmaps Generated"],["$0","Required to Start"],["7 Days","To First Plan"],["Now Live","Platform Open"]].map(([v,l]) => (
            <div key={l}>
