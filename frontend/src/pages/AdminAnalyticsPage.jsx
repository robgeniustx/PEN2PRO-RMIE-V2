    ...
    <div className="min-h-screen" style={{ background: "#080C14" }}>
      ...
      <div className="mx-auto max-w-7xl px-5 py-12">
        <div className="mb-8">
          ...
          <h1 className="font-display text-3xl font-black text-white mt-1">Event Intelligence</h1>
          <p className="text-sm text-slate-500">Tier distribution, top features, and recent tracked activity.</p>
        </div>
