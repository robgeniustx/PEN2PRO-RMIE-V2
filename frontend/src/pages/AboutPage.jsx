...
const PERSONAL_STATEMENT = [
  ...
  { body: "After coming home from prison, I tried to rebuild my life the way people tell you to rebuild it — apply for jobs, show up professionally, interview well, and wait for somebody to give you a chance. More than once, I earned the opportunity. The interviews went well. The job offers came." },
  { body: "Then the background checks followed. The offers were rescinded.", emphasis: true },
  { body: "That kind of rejection can break a person. For a moment, it almost did. I had a day of moping, sitting with the frustration and the question of why the doors kept closing after they had already looked open." },
  { body: "Then I picked my head up and took off running.", callout: true },
  { body: "If the system was not going to hand me an opportunity, I was going to build one.", emphasis: true },
