...
const PERSONAL_STATEMENT = [
  ...
  { body: "When I came home, I tried to rebuild my life the way people tell you to rebuild it." },
  { body: "I applied for jobs. I showed up professionally, interviewed well, said the right things, and waited for someone to give me a chance. More than once, I earned that chance. The interviews went well. The job offers came." },
  { body: "Then the background checks came back.", emphasis: true },
  { body: "One by one, the offers I had already earned were rescinded. Doors that had already opened closed again — harder than before." },
  { body: "That kind of rejection can break a person. For one day, it nearly broke me. I spent that day moping, frustrated, asking why I could do everything right and still end up back at zero." },
  { body: "Then I picked my head up and took off running.", callout: true },
  { body: "If the system was not going to hand me an opportunity, I was going to build one myself. That decision became the foundation for everything that followed — business ownership, mentorship, authorship, community work, and now PEN2PRO." },
