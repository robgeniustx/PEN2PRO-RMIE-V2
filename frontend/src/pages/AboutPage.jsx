...
const PERSONAL_STATEMENT = [
  ...
  { body: "When I came home, I tried to do things the way people tell you to do them. Apply for jobs. Show up professionally. Interview well. Wait for somebody to give you a chance." },
  ...
  { body: "The offers were rescinded. Doors that had already looked open closed again, one after another." },
  { body: "That kind of rejection can break a person. For a moment, it almost did. I spent a day moping — frustrated, asking why I kept doing everything right and still getting shut out." },
  { body: "Then I picked my head up and took off running.", callout: true },
  { body: "If the system was not going to hand me an opportunity, I was going to build one myself." },
