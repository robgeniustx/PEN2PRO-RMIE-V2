...
const PERSONAL_STATEMENT = [
  ...
  { body: “After a day of moping, frustration, and asking why doors kept closing after they had already looked open, Robert made a decision.”, callout: false },
  ...
  { body: “Robert is a service-connected veteran, father, entrepreneur, author, and credible messenger. He built real businesses — starting with XLR8 Pressure Washing — learned through heartbreak and success, and created PEN2PRO RMIE to help others turn ideas into income without being blocked by their past, lack of resources, or lack of business knowledge.” },
          ...
          <div className="mt-12 flex items-center gap-5 rounded-2xl border border-[#1A2D50] bg-[#0F1520] p-6">
            ...
            <div>
              ...
              <p className="text-sm text-slate-400 mt-0.5">
                Service-Connected Veteran · Father · Entrepreneur · Author · Credible Messenger
              </p>
