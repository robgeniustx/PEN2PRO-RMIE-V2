...
const PERSONAL_STATEMENT = [
  ...
  { body: "The same energy used to survive difficult seasons can become the same energy used to build an extraordinary life.", emphasis: true },
    ...
    <div className="relative min-h-screen bg-[#0A0F1E] text-white overflow-hidden">
      ...
      <section className="px-5 py-20">
        <div className="mx-auto max-w-3xl">
          ...
          {/* Primary founder story — specific beats */}
          <div className="space-y-6 text-[1.05rem] leading-[1.85] text-slate-300 mb-16">
            {FOUNDER_STORY.map((item) => {
              if (item.callout) {
                return (
          ...
          <div className="mb-12 flex items-center gap-4">
            <div className="h-px flex-1 bg-[#1A2D50]" />
            <span className="text-xs font-bold uppercase tracking-widest text-[#FF8A00]">In His Own Words</span>
            <div className="h-px flex-1 bg-[#1A2D50]" />
          </div>
