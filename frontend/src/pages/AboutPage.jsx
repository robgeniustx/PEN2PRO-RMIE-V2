...
const PERSONAL_STATEMENT = [
  ...
  { body: "More than once, I earned that chance. The interviews went well. The job offers came.", emphasis: true },
  { body: "Then the background checks came back." },
  { body: "The offers were rescinded.", callout: true },
  { body: "That kind of rejection can break a person. For a moment, it almost broke me. I spent a day moping — frustrated, exhausted, asking why doors kept closing after they had already looked open." },
