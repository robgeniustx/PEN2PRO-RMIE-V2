...
const PERSONAL_STATEMENT = [
  ...
  { body: “That kind of rejection can break a person. For a moment, it almost did. After a day of moping, frustration, and asking why doors kept closing, Robert made a decision.” },
  ...
  { body: “That journey started with XLR8 Pressure Washing, then XLR8 Trade Academy, and now PEN2PRO — each built from the same place: the refusal to accept that a door closing is the end of the story.” },
  { body: “What began as a mission to rebuild one life became a mission to help others rebuild theirs.”, emphasis: true },
  { body: “PEN2PRO was not created by someone who was handed every opportunity. It was built through struggle, pressure, setbacks, sacrifice, discipline, rebuilding, and vision.” },
  { body: “It was built for people who know they are capable of more but need direction, structure, strategy, tools, and a real roadmap to unlock what is already inside of them.” },
