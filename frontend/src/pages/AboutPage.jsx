...
const PERSONAL_STATEMENT = [
  { body: “Robert Green did not create PEN2PRO from a comfortable office or a perfect path. He created it from pressure, rejection, discipline, and the refusal to stay stuck.”, emphasis: true },
  { body: “After coming home from prison, Robert tried to rebuild his life the way people tell you to rebuild it — apply for jobs, show up professionally, interview well, and wait for somebody to give you a chance.” },
  ...
  { body: “After a day of moping, frustration, and asking why doors kept closing after they had already looked open, Robert made a decision.” },
  { body: “He picked his head up and took off running.”, emphasis: true },
  ...
  { body: “PEN2PRO is Robert’s way of sharing the success, the heartbreak, the lessons, the failures, and the strategies with the world.” },
  { body: “It is built for people with ideas but no structure. People with skills but no roadmap. People with ambition but limited resources. People who have been overlooked, underestimated, or counted out.”, emphasis: true },
  { body: “During that rebuilding process, Robert learned something that changed everything:” },
  ...
  { body: “Robert started studying business, strategy, branding, mindset, discipline, leadership, and personal growth — obsessed with understanding how successful people think, move, build, and create opportunity where none existed.” },
  { body: “That journey started with XLR8 Pressure Washing, then XLR8 Trade Academy, and eventually became PEN2PRO.” },
  ...
  { body: “You still have purpose.\nYou still have value.\nYou still have a future that has not been written yet.”, list: true },
  { body: “And sometimes, the person the world counted out becomes the very person who inspires others to believe in themselves again.”, emphasis: true },
