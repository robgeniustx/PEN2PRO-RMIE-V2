...
const PERSONAL_STATEMENT = [
  ...
  { body: “Robert built XLR8 Pressure Washing from the ground up. He learned through real losses, real wins, real setbacks, and real lessons — the kind that no classroom can teach.” },
  { body: “PEN2PRO is Robert’s way of sharing the success, the heartbreak, the failures, and the strategies with the world. It is built for people with ideas but no structure. People with skills but no roadmap. People with ambition but limited resources. People who have been overlooked, underestimated, or counted out.” },
