...
const PERSONAL_STATEMENT = [
  ...
  { body: "Robert Green is a service-connected veteran, father, entrepreneur, author, mentor, credible messenger, and the founder of PEN2PRO. He built this platform to share both the success and the heartbreak — the wins, losses, setbacks, lessons, and strategies — with people who need a real roadmap, not motivational fluff." },
  ...
  { body: "It was built through struggle, pressure, setbacks, sacrifice, discipline, rebuilding, and vision. It was built by someone who knows what it feels like to be counted out, overlooked, judged, and underestimated — and then decided to build anyway." },
