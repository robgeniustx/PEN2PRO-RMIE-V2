...
const PERSONAL_STATEMENT = [
  ...
  { body: "Then the background checks came back, and the offers were rescinded.", emphasis: true },
  { body: "Doors that had already looked open closed again, one after another.", },
  { body: "That kind of rejection can break a person. For a moment, it almost did. I spent a day moping — frustrated, angry, asking why I kept doing everything right and still getting shut out." },
  { body: "Then I picked my head up and took off running.", callout: true },
  { body: "If the system would not hand me an opportunity, I would build one.", emphasis: true },
