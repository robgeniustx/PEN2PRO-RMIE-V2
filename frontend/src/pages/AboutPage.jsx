...
const PERSONAL_STATEMENT = [
  {
    body: "Robert Green did not create PEN2PRO from a comfortable office or a perfect path. He built it from pressure, rejection, discipline, and the refusal to stay stuck.",
  },
  {
  ...
  {
    body: "Then the background checks followed. The offers were rescinded.",
    callout: true,
  },
  {
  ...
  {
    body: "Even before coming home, during the hardest seasons of his life, Robert had already started the internal work — studying business, strategy, branding, mindset, discipline, and leadership. He became obsessed with understanding how successful people think, move, build, and create opportunities.",
  },
  {
    body: "He learned that wealth is not just money. Wealth is knowledge. Wealth is execution. Wealth is discipline. Wealth is believing in yourself long enough to keep going when nobody else can see what you see.",
    emphasis: true,
  },
  {
  ...
  {
    body: "What began as a mission to rebuild his own life became a mission to help others rebuild theirs.",
    emphasis: true,
  },
  {
  ...
  {
    body: "It is built for people with ideas but no structure. People with skills but no roadmap. People with ambition but limited resources. People who have been overlooked, underestimated, or counted out.",
  },
  {
  ...
  {
    body: "Your current chapter is not your final chapter.",
    emphasis: true,
  },
  {
    body: "No matter where you started. No matter what people said about you. No matter how many times life knocked you down. No matter how long you have felt stuck — you still have purpose, you still have value, and you still have greatness inside of you waiting to be activated.",
  },
  {
  ...
  {
    body: "Because redemption is real. Growth is real. Success is possible.",
    emphasis: true,
  },
  {
  ...
  {
    body: "That is what PEN2PRO represents. That is what this story represents. And this is only the beginning.",
    callout: true,
  },
];
