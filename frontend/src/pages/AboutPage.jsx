...
const PERSONAL_STATEMENT = [
  { body: “I did not build PEN2PRO from a comfortable place. I built it from pressure, rejection, discipline, and the refusal to stay stuck.” },
  { body: “After coming home from prison, I tried to do things the right way — the way people tell you to rebuild your life. Apply for jobs. Show up professionally. Interview well. Wait for somebody to give you a chance.” },
  { body: “More than once, I earned the opportunity. The interviews went well. The job offers came. I started believing things were finally turning around.”, emphasis: true },
  { body: “Then the background checks followed.” },
  { body: “The offers were rescinded.”, callout: true },
  { body: “That kind of rejection can break a person. For a moment, it almost did. After a day of moping, frustration, and asking why doors kept closing after they had already looked open — I made a decision.” },
  { body: “I picked my head up and took off running.”, emphasis: true },
  { body: “If the system was not going to hand me a path, I would build one.” },
  ...
  { body: “Your past may explain parts of your story, but it does not own your future. And the same energy used to survive difficult seasons can become the same energy used to build an extraordinary life.” },
  { body: “The truth is, many people are only one decision away from a completely different life.\nOne decision to believe in themselves again.\nOne decision to commit to becoming who they were created to be.”, list: true },
