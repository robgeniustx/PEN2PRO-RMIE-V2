...
const PERSONAL_STATEMENT = [
  ...
  { body: "When I came home, I tried to do it the way people tell you to do it — apply for jobs, show up professionally, interview well, and wait for somebody to give you a chance. More than once, I earned that chance. The interviews went well. The job offers came." },
  { body: "Then the background checks came back.", emphasis: true },
  { body: "The offers were rescinded.", callout: true },
  { body: "That kind of rejection can break a person. For a moment, it almost did. I spent a day moping — frustrated, angry, asking why doors kept closing after they had already looked open." },
