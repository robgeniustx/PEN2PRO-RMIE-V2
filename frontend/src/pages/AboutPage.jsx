...
const PERSONAL_STATEMENT = [
  ...
  { body: "When I came home, I tried to rebuild my life the way people tell you to rebuild it — apply for jobs, show up professionally, interview well, and wait for somebody to give me a chance." },
  ...
  { body: "After a day of moping, frustration, and asking why doors kept closing, I made a decision." },
  { body: "I picked my head up and took off running. If the system would not give me a path, I would build one.", callout: true },
