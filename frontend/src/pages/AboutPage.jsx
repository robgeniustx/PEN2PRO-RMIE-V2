...
const PERSONAL_STATEMENT = [
  ...
  { body: “That kind of rejection can break a person. For a moment, it almost did. After a day of moping, frustration, and asking why doors kept closing — even when he had done everything right — Robert made a decision.” },
  ...
  { body: “That is what PEN2PRO was created for.”, emphasis: true },
