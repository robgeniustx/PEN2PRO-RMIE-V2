...
const PERSONAL_STATEMENT = [
  ...
  { body: "After coming home from prison, Robert tried to rebuild his life the way people are told to rebuild it — apply for jobs, show up professionally, interview well, and wait for somebody to give you a chance." },
  ...
  { body: "Opportunities that looked real — gone. Doors that had already opened — closed. The system made it clear it was not built for people carrying his history, no matter how well he performed." },
  { body: "That kind of rejection can break a person. For a moment, it almost did." },
  { body: "After a day of moping, frustration, and asking why every door kept closing, Robert made a decision.", emphasis: true },
  { body: "He picked his head up. And he took off running.", callout: true },
  ...
  { body: "It was not easy. Real transformation never is." },
  { body: "There were nights filled with doubt and mornings filled with uncertainty. But even in that darkness, one thought held:" },
  ...
  { body: "Robert started studying business, strategy, branding, and personal growth. He became obsessed with understanding how successful people think, move, build, and create opportunities without waiting for permission." },
  { body: "He learned that wealth is not just money. Wealth is knowledge. Wealth is execution. Wealth is discipline. Wealth is believing in yourself long enough to keep going when nobody else can see what you see.", emphasis: true },
  { body: "That journey started with XLR8 Pressure Washing and eventually led to XLR8 Trade Academy and PEN2PRO." },
  { body: "What began as a mission to rebuild one life became a mission to help others rebuild theirs.", emphasis: true },
  ...
  { body: "And it was built for people who know they are capable of more — but need direction, structure, strategy, and tools to unlock what is already inside of them." },
  { body: "Your environment does not have to define your destiny.", callout: true },
  { body: "Your past may explain parts of your story. But it does not own your future. And the same energy used to survive difficult seasons can become the energy used to build something extraordinary." },
  { body: "PEN2PRO is bigger than software.", emphasis: true },
  { body: "It is proof that transformation is possible. Proof that someone can come from hardship and still create something meaningful. Proof that ideas can become income, pain can become purpose, and setbacks can become fuel for a completely different future." },
  ...
  { body: "No matter where you started. No matter what people said about you. No matter how many times life knocked you down. No matter how long you have felt stuck." },
  { body: "You still have purpose. You still have value. You still have greatness waiting to be activated.", emphasis: true },
  ...
  { body: "Because redemption is real. Growth is real. Success is possible.", emphasis: true },
  ...
  { body: "That is what PEN2PRO represents. That is what this story represents.", emphasis: true },
