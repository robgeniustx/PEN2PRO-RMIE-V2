...
const PERSONAL_STATEMENT = [
  ...
  {
    body: "More than once, he earned the opportunity.",
    emphasis: true,
  },
  {
  ...
  {
    body: "Robert is a service-connected veteran, father, entrepreneur, author, mentor, credible messenger, and founder of PEN2PRO. What he built did not come from a business school or a startup incubator. It came from lived experience, real setbacks, and the discipline to keep moving when the easiest option was to stop.",
  },
  {
