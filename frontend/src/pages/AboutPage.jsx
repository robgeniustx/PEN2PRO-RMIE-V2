...
const PERSONAL_STATEMENT = [
  ...
  { body: “The interviews went well. The job offers came.” },
  ...
  { body: “Robert is a service-connected veteran, father, entrepreneur, author, mentor, credible messenger, and founder of PEN2PRO.” },
  { body: “He built XLR8 Pressure Washing, XLR8 Trade Academy, and PEN2PRO from the ground up. Not from a comfortable office. Not from a perfect path. From lived experience, discipline, and the understanding that your past does not own your future.”, emphasis: true },
