...
const PERSONAL_STATEMENT = [
  ...
  { body: "More than once, I earned the opportunity. The interviews went well. The job offers came. Then the background checks followed, and the offers were rescinded." },
