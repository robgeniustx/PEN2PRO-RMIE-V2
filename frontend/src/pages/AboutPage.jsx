...
const PERSONAL_STATEMENT = [
  ...
  { body: "Most business tools talk around the problem. PEN2PRO gives you the actual moves. Not motivation speeches — real steps, real structure, real execution support built from real experience." },
  ...
  { body: "That is what PEN2PRO represents. That is what Robert’s story represents.", emphasis: true },
