...
const PERSONAL_STATEMENT = [
  ...
  { body: "When I came home, I tried to do it the way people tell you to do it — apply for jobs, show up on time, dress the part, interview well, and wait for somebody to give me a chance." },
  { body: "More than once, I earned that chance. The interviews went well. The job offers came in." },
  { body: "Then the background checks came back.", emphasis: true },
  { body: "The offers were rescinded. Doors that had already looked open closed right in front of me — after I had already walked through them." },
  { body: "That kind of rejection can break a person. For a moment, it almost did. I spent a day moping — frustrated, angry, asking why I kept getting counted out for something I had already paid for." },
  { body: "Then I picked my head up and took off running.", callout: true },
  { body: "If the system was not going to hand me an opportunity, I was going to build one." },
