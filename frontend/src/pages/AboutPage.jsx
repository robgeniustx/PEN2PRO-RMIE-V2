...
const PERSONAL_STATEMENT = [
  { body: "I did not create PEN2PRO from a perfect path. I created it from pressure, rejection, discipline, and the refusal to stay stuck." },
  ...
  { body: "I am a service-connected veteran, a father, an entrepreneur, an author, a mentor, and a credible messenger. PEN2PRO is my way of sharing the success, the heartbreak, the lessons, the failures, and the strategies with the world." },
