...
const PERSONAL_STATEMENT = [
  ...
  { body: "After coming home, I tried to rebuild my life the way people tell you to rebuild it — apply for jobs, show up professionally, interview well, and wait for somebody to give you a chance. More than once, I earned the opportunity. The interviews went well. The job offers came." },
  { body: "Then the background checks followed.", emphasis: true },
  { body: "The offers were rescinded.", emphasis: true },
  { body: "That kind of rejection can break a person. For a moment, it almost did. There were nights filled with regret, mornings filled with uncertainty, and moments when giving up felt easier than believing in a future I could not yet see." },
