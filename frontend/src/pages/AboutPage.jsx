...
const PERSONAL_STATEMENT = [
  ...
  { body: "More than once, he earned the opportunity.", emphasis: true },
  { body: "The interviews went well. The job offers came. Then the background checks followed." },
  { body: "The offers were rescinded.", callout: true },
  { body: "Opportunities disappeared. Doors closed after they had already looked open. That kind of rejection can break a person. For a moment, it almost did." },
  ...
  { body: "That journey started with XLR8 Pressure Washing and eventually led to XLR8 Trade Academy and PEN2PRO — built through struggle, pressure, setbacks, sacrifice, discipline, rebuilding, and vision." },
  { body: "PEN2PRO is Robert’s way of sharing the success, the heartbreak, the lessons, the failures, and the strategies with the world.", emphasis: true },
  ...
  { body: "PEN2PRO RMIE — Rapid Monetization Intelligence Engine — was created to help users turn an idea into a realistic action plan. It gives people more than motivation.", emphasis: true },
  { body: "It gives them business structure, launch steps, monetization strategy, credit and funding readiness, branding direction, and a path toward execution." },
  ...
  { body: "PEN2PRO was not built by someone who was handed every opportunity. It was built by someone who knows what it feels like to be counted out, overlooked, judged, and underestimated.", emphasis: true },
  { body: "And it was built for the people who know they are capable of more." },
];
