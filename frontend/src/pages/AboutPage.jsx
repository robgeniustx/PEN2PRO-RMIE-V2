...
export default function AboutPage() {
  ...
  return (
    <div className="relative min-h-screen bg-[#0A0F1E] text-white overflow-hidden">
      ...
      {/* ── ORIGIN STORY — specific background check narrative ── */}
      <section className="px-5 py-20 border-t border-[#1A2D50]">
        <div className="mx-auto max-w-3xl">
          ...
          <div className="space-y-6 text-[1.05rem] leading-[1.9] text-slate-300">
            ...
            <p>
              After coming home from prison, Robert tried to rebuild his life the way people are told to rebuild it — apply for jobs, show up professionally, interview well, and wait for somebody to give him a chance. More than once, he earned the opportunity.
            </p>
            <p>
              The interviews went well. The job offers came.
            </p>
            ...
            <p>
              Opportunities disappeared. Doors closed after they had already looked open. That kind of rejection can break a person. For a moment, it almost did.
            </p>
            <p>
              After a day of moping, frustration, and asking why doors kept closing, Robert made a decision.
            </p>
            <p className="border-l-4 border-[#D4A017] pl-5 text-xl font-bold text-white">
            ...
            <p className="text-lg font-bold text-white">
              PEN2PRO is Robert's way of sharing the success, the heartbreak, the lessons, the failures, and the strategies with the world.
            </p>
            <p>
              It is built for people with ideas but no structure. People with skills but no roadmap. People with ambition but limited resources. People who have been overlooked, underestimated, or counted out.
            </p>
          ...
          <div className="mt-12 flex items-center gap-5 rounded-2xl border border-[#1A2D50] bg-[#0F1520] p-6">
            ...
            <div>
              ...
              <p className="text-sm font-semibold mt-0.5" style={{ color: "#FF8A00" }}>
                Founder — PEN2PRO RMIE
              </p>
            </div>
          </div>
        </div>
      ...
      <section className="px-5 py-16 border-t border-[#1A2D50] bg-[#0F1520]/40">
        <div className="mx-auto max-w-3xl">
