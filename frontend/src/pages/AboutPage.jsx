...
const PERSONAL_STATEMENT = [
  ...
  { body: “Robert is a service-connected veteran, father, entrepreneur, author, mentor, credible messenger, and the founder of PEN2PRO. He did not build this platform from theory. He built it from lived experience.” },
