...
const PERSONAL_STATEMENT = [
  ...
  { body: “Opportunities were limited. Doors kept closing. Every mistake I had ever made seemed to follow me longer than any good thing I had done. I carried frustration, doubt, and the heavy feeling of knowing there was more inside of me than what the world could see.” },
  { body: “During my incarceration, I was faced with a choice.”, emphasis: true },
  { body: “I could accept the labels placed on me, or I could rebuild myself from the inside out. That process was not easy. Real change never is.” },
  { body: “Any effort toward something positive had to be better than where I was.”, callout: true },
  { body: “I started studying business, strategy, branding, discipline, and leadership. I learned that wealth is not just money — it is knowledge, execution, and the discipline to keep going when nobody else can see what you see.” },
  ...
  { body: “It was built through struggle, pressure, setbacks, sacrifice, and vision. It was built by someone who knows what it feels like to be counted out, overlooked, and underestimated.” },
