...
const PERSONAL_STATEMENT = [
  ...
  { body: “After coming home from prison, Robert tried to rebuild his life the way people tell you to rebuild it — apply for jobs, show up professionally, interview well, and wait for somebody to give you a chance.”, emphasis: true },
  ...
  { body: “The offers were rescinded. Opportunities disappeared. Doors that had already looked open — closed.” },
  ...
  { body: “PEN2PRO RMIE — Rapid Monetization Intelligence Engine — was created to help users turn an idea into a realistic action plan.”, emphasis: true },
  { body: “It gives people more than motivation. It gives them business structure, launch steps, monetization strategy, credit and funding readiness, branding direction, and a path toward execution.” },
  { body: “This is not just software.”, callout: true },
  { body: “This is a second-chance engine, a business builder, and a roadmap for people ready to stop waiting for permission.” },
  { body: “Your environment does not have to define your destiny.”, emphasis: true },
  { body: “Your past may explain parts of your story, but it does not own your future. And the same energy used to survive difficult seasons can become the same energy used to build an extraordinary life.”, emphasis: true },
  { body: “That journey started with XLR8 Pressure Washing and eventually led to XLR8 Trade Academy and PEN2PRO — built by someone who knows what it feels like to be counted out, overlooked, and judged.” },
  { body: “And built for people who know they are capable of more.”, emphasis: true },
  { body: “Your current chapter is not your final chapter.”, callout: true },
];
