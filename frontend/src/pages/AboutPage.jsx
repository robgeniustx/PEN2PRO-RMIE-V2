...
const PERSONAL_STATEMENT = [
  ...
  { body: “Then the background checks followed, and the offers were rescinded.”, emphasis: true },
  { body: “That kind of rejection can break a person. For a moment, it almost did.” },
  { body: “After a day of moping, frustration, and asking why doors kept closing after they had already looked open — Robert made a decision.”, callout: true },
  ...
  { body: “During his time rebuilding, Robert learned something that changed his life:” },
  ...
  { body: “And the same energy used to survive the most difficult seasons can become the same energy used to build an extraordinary life.”, emphasis: true },
  { body: “He started studying business, strategy, branding, discipline, and leadership. He became obsessed with understanding how people build opportunities from nothing. That journey started with XLR8 Pressure Washing and eventually led to XLR8 Trade Academy and PEN2PRO.” },
  { body: “What began as a mission to rebuild his own life became a mission to help others rebuild theirs.”, emphasis: true },
  ...
  { body: “It was built through struggle, pressure, setbacks, sacrifice, discipline, and vision. It was built by someone who knows what it feels like to be counted out, overlooked, and underestimated — and who refused to stay there.” },
  { body: “Because redemption is real. Growth is real. And the person the world counted out can still become the person who inspires others to believe in themselves again.”, emphasis: true },
