...
const PERSONAL_STATEMENT = [
  ...
  { body: “More than once, he earned the opportunity. The interviews went well. The job offers came. He started believing that life was finally turning around.” },
  { body: “Then the background checks came back.”, callout: true },
  { body: “The offers were rescinded. Opportunities disappeared. Doors closed after they had already looked open.” },
  { body: “That kind of rejection can break a person. For a moment, it almost did.” },
  { body: “After a day of moping, frustration, and asking why doors kept closing, Robert made a decision.”, emphasis: true },
  ...
  { body: “You still have purpose. You still have value. You still have greatness inside of you waiting to be activated.” },
