...
const PERSONAL_STATEMENT = [
  ...
  { body: “There was a time when everything around him looked broken. Opportunities were limited. Every mistake seemed to follow longer than any good thing he had ever done.” },
  { body: “But even in that darkness, one thought held:” },
  ...
  { body: “That realization sparked a transformation. He started studying business, strategy, branding, mindset, discipline, and leadership. He became obsessed with understanding how successful people think, move, build, and create opportunity.” },
  ...
  { body: “It is proof that transformation is possible. It is proof that someone can come from hardship and still create something meaningful. It is proof that ideas can become income, pain can become purpose, and setbacks can become fuel for a completely different future.” },
  ...
  { body: “And this is only the beginning.”, emphasis: true },
];
