...
const PERSONAL_STATEMENT = [
  ...
  { body: "When I came home, I tried to do it the way people tell you to do it — apply for jobs, show up professional, interview well, and wait for somebody to give you a chance." },
  ...
  { body: "The offers were rescinded. Doors that looked wide open closed right in front of me — after I had already done everything right.", callout: true },
  { body: "That kind of rejection can break a person. For a moment, it almost did. I gave myself one day to mope, to sit with the frustration, to ask why the doors kept closing no matter what I did." },
