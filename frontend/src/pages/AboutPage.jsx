...
const PERSONAL_STATEMENT = [
  ...
  { body: "That kind of rejection can break a person. For a moment, it almost did. I had a day of moping — frustration, doubt, and asking why doors kept closing after they had already looked open." },
  { body: "But after that day, I picked my head up and took off running.", emphasis: true },
