...
const PERSONAL_STATEMENT = [
  ...
  { body: "That kind of rejection can break a person. For a moment, it almost did. I remember a day of moping, frustration, and asking myself why the doors kept closing no matter how hard I tried to do things the right way." },
  { body: "Then I picked my head up and took off running.", callout: true },
  { body: "If the system was not going to hand me an opportunity, I decided I would build one myself. That decision became the foundation for XLR8 Pressure Washing, XLR8 Trade Academy, and now PEN2PRO." },
