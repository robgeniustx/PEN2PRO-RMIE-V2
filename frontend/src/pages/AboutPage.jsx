...
const PERSONAL_STATEMENT = [
  ...
  { body: “Robert is a service-connected veteran, father, entrepreneur, author, mentor, credible messenger, and founder of PEN2PRO. He built every piece of this from lived experience — not from a classroom, not from a comfortable office, not from a perfect past.” },
  { body: “He built it from the refusal to stay stuck.”, emphasis: true },
