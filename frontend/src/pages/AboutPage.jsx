...
const PERSONAL_STATEMENT = [
  // ── The specific story: coming home, jobs, background checks ──
  {
  ...
  {
    body: “During incarceration, Robert was faced with the same choice every person in that situation faces.”,
    emphasis: true,
  },
  {
  ...
  {
    body: “There were nights filled with regret and mornings filled with uncertainty. But even in that space, one thought stayed constant:”,
  },
  {
    body: “Any effort toward something positive had to be better than where he was and what he had already experienced.”,
    callout: true,
  },
  {
    body: “He started studying business, strategy, branding, mindset, discipline, and leadership. He became obsessed with understanding how successful people think, move, build, and create opportunities.”,
  },
  {
    body: “Your environment does not have to define your destiny.”,
    emphasis: true,
  },
  {
    body: “Your past may explain parts of your story, but it does not own your future.”,
    emphasis: true,
  },
  {
  ...
  {
    body: “PEN2PRO is bigger than software.”,
    emphasis: true,
  },
  {
