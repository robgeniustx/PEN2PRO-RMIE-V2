...
const PERSONAL_STATEMENT = [
  ...
  { body: “After coming home from prison, Robert tried to rebuild his life the way people are told to rebuild it — apply for jobs, show up professionally, interview well, and wait for somebody to give him a chance.”, emphasis: false },
  ...
  { body: “The offers were rescinded. Every time.” },
  { body: “That kind of rejection can break a person. For a moment, it almost did. After a day of moping, frustration, and asking why doors kept closing after they had already looked open — Robert made a decision.” },
  ...
  { body: “PEN2PRO RMIE — Rapid Monetization Intelligence Engine — was created to help users turn an idea into a realistic action plan. It gives people more than motivation. It gives them business structure, launch steps, monetization strategy, credit and funding readiness, branding direction, and a path toward execution.”, emphasis: true },
  { body: “This is not just software.”, emphasis: true },
  { body: “This is a second-chance engine, a business builder, and a roadmap for people ready to stop waiting for permission.”, callout: true },
  { body: “During the difficult years, Robert faced a choice: accept the labels placed on him and become another statistic, or rebuild from the inside out. Real change is never easy.” },
  { body: “There were nights filled with regret, mornings filled with uncertainty, and moments when giving up felt easier than believing in a future he could not yet see.” },
  { body: “Any effort toward something positive had to be better than where he was.”, callout: true },
  { body: “Even the smallest step forward meant something. That mindset became the beginning of transformation.” },
  ...
  { body: “Robert studied business, strategy, branding, mindset, discipline, leadership, and personal growth. He became obsessed with understanding how successful people think, move, build, and create opportunities.” },
  ...
  { body: “PEN2PRO was not created by someone who was handed every opportunity. It was built through struggle, pressure, setbacks, sacrifice, discipline, rebuilding, and vision.”, emphasis: true },
  { body: “It was built for people who know they are capable of more but need direction, structure, strategy, tools, and belief to unlock what is already inside of them.” },
