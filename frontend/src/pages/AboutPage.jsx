...
const PERSONAL_STATEMENT = [
  ...
  { body: “During incarceration, Robert was faced with a choice.”, emphasis: true },
  ...
  { body: “There were nights filled with regret, mornings filled with uncertainty, and moments when giving up felt easier than believing in a future he could not yet see. But even in that darkness, he held onto one thought:” },
  { body: “Any effort toward something positive had to be better than where he was.”, callout: true },
  { body: “That mindset became the beginning of a transformation — and the seed of PEN2PRO.” },
  ...
  { body: “Robert started studying business, strategy, branding, discipline, leadership, and personal growth. He became obsessed with understanding how successful people think, move, build, and create opportunities. That journey started with XLR8 Pressure Washing and eventually led to XLR8 Trade Academy and PEN2PRO.” },
