...
const PERSONAL_STATEMENT = [
  ...
  { body: "Robert Green is a service-connected veteran, father, entrepreneur, author, mentor, credible messenger, and founder of PEN2PRO." },
  { body: "He built PEN2PRO from struggle, pressure, setbacks, sacrifice, discipline, rebuilding, and vision — so that other people who have been counted out would have something real to work with." },
