          ...
          <div className="grid grid-cols-1 gap-8 lg:grid-cols-2">
            <div>
              ...
              <p className="text-slate-400 text-sm leading-7 mb-6">
                Refer other founders, veterans, and entrepreneurs to PEN2PRO and earn commissions on every upgrade. Our affiliate program is launching now alongside early platform access.
              </p>
            ...
            <div>
              ...
              <div className="space-y-4">
                {[
                  ...
                  { step: "2", title: "Get Your Link", desc: "We'll send you a unique referral link and affiliate dashboard login when the program activates." },
