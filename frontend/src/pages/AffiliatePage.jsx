...
const RESOURCES = [
  ...
  { name: "Fundera", category: "Funding Partners", desc: "Compare small business loans, lines of credit, and SBA options from vetted lenders.", url: import.meta.env.VITE_AFFILIATE_FUNDING_URL || "https://www.fundera.com" },
  { name: "Lendio", category: "Funding Partners", desc: "One application, matched to 75+ funding partners for startup and growth capital.", url: "https://www.lendio.com" },
