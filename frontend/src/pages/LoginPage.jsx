...
const TIER_BENEFITS = [
  { tier: "Free Forever", color: "#1E88E5", icon: "🗺️", desc: "Instant AI business roadmap — no credit card required." },
  { tier: "Pro", color: "#D4A017", icon: "📊", desc: "Full roadmap, sales scripts, credit checklist, PDF export, AI refinement." },
  { tier: "Elite", color: "#00C9B1", icon: "🏗️", desc: "Advanced strategy, financial projections, funding resources, done-with-you guidance." },
  { tier: "Legacy Founder", color: "#FF8A00", icon: "🔥", desc: "Lifetime access, early adopter pricing, full platform + future features. 200 spots only." },
];
    ...
    <div className="min-h-screen" style={{ background: "#080C14" }}>
      ...
      <div className="flex min-h-[calc(100vh-80px)] items-start justify-center px-4 py-16">
        <div className="flex w-full max-w-5xl flex-col gap-8 lg:flex-row lg:items-start">
          ...
          {/* Side Panel — Tier Benefits */}
          <div className="w-full lg:w-80 shrink-0">
            <div className="rounded-2xl border border-[#1A2235] bg-[#0F1520] p-6">
              <p className="mb-1 text-xs font-bold uppercase tracking-widest text-[#D4A017]">PEN2PRO Plans</p>
              <h2 className="mb-1 font-display text-xl font-black text-white leading-snug">
                Build your roadmap.<br />Save your blueprint.<br />Upgrade when ready.
              </h2>
              <p className="mb-6 text-xs text-slate-500">Start free. No credit card required.</p>
              <div className="space-y-3">
                {TIER_BENEFITS.map((t) => (
                  <div key={t.tier} className="flex items-start gap-3 rounded-xl border border-[#1A2235] p-3.5">
              ...
              <div className="mt-5 rounded-xl border border-[#1A2235] bg-[#080C14] p-4 text-center">
                ...
                <Link to="/waitlist" className="mt-1 block text-sm font-bold" style={{ color: "#D4A017" }}>
                  Join the waitlist →
                </Link>
              </div>
            </div>
