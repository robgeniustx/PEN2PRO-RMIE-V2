...
const TIER_VALUE_PROPS = [
  {
    ...
    color: "#00C9B1",
    icon: "🗺️",
    desc: "AI-generated business blueprint in under 5 minutes. No card required.",
  },
  {
    tier: "Pro — $249/mo",
    color: "#2d9cff",
    icon: "📊",
    desc: "Full roadmap, progress tracking, branding support, PDF export, and outreach strategy.",
  },
  {
    tier: "Elite — $499/mo",
    color: "#d4af37",
    icon: "🧠",
    desc: "Advanced strategy, financial projections, legal foundation, vendor & funding resources.",
  },
  {
    tier: "Legacy Founder — $1,899",
    color: "#FF8A00",
    icon: "🏆",
    desc: "Lifetime access. Every feature. One price. Only 200 spots available.",
  },
];
  ...
  return (
    <div className="min-h-screen" style={{ background: "#080C14" }}>
      ...
      <div className="flex min-h-[calc(100vh-64px)] items-stretch">
        ...
        <div
          className="hidden lg:flex lg:w-[42%] flex-col justify-between px-12 py-16 relative overflow-hidden"
          style={{ background: "linear-gradient(160deg, #0A0F1E 0%, #0D1528 60%, #111827 100%)" }}
        >
          {/* Background orbs */}
          ...
          <div className="relative space-y-8">
            <div>
              ...
              <p className="mt-4 text-base text-slate-400 leading-relaxed">
                PEN2PRO RMIE turns your idea into a realistic business roadmap — with launch plans, funding readiness, outreach strategy, and execution support at every tier.
              </p>
            </div>
          ...
          <div className="relative">
            <p className="text-xs text-slate-600">
              Built by Robert Green — veteran, entrepreneur, and founder dedicated to helping overlooked builders turn ideas into income.
            </p>
          </div>
        </div>

        {/* ── RIGHT PANEL — form ── */}
        <div className="flex flex-1 flex-col items-center justify-center px-5 py-12 lg:px-16">
          <div className="w-full max-w-md">
            ...
            <div className="mb-8 text-center">
              ...
              <p className="mt-2 text-sm text-slate-400">
                {tab === "login"
                  ...
                  : "Start building your business roadmap — free, no card required"}
              </p>
            </div>
            ...
            <div className="rounded-2xl border border-[#1A2235] p-8" style={{ background: "#0F1520" }}>
              ...
              {tab === "login" && (
                <form onSubmit={handleLogin} className="space-y-5">
                  ...
                  <button
                    type="submit"
                    disabled={loading}
                    className="btn-gold w-full rounded-xl py-3.5 text-sm font-bold disabled:opacity-60"
                  >
              ...
              {/* Bottom links */}
              <div className="mt-6 space-y-3 border-t border-[#1A2235] pt-5 text-center text-sm text-slate-500">
                <p>
