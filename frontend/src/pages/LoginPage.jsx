...
export default function LoginPage() {
  ...
  const TIER_BENEFITS = [
    { icon: "🆓", tier: "Free Roadmap", desc: "1 AI business roadmap with basic launch steps and brand name ideas — no credit card needed." },
    { icon: "⚡", tier: "Pro — $249/mo", desc: "Full roadmap, 7/30/90-day plans, branding support, PDF export, credit & funding checklist, sales scripts." },
    { icon: "🏆", tier: "Elite — $499/mo", desc: "Everything in Pro + financial projections, legal foundation, vendor resource center, automation & priority support." },
    { icon: "♾️", tier: "Founders Lifetime — $1,899", desc: "One payment. Full platform forever. Every feature we ship. Limited to 200 spots. Closes August 1, 2026." },
  ];
        ...
        <div className="w-full max-w-5xl grid gap-10 lg:grid-cols-2 lg:items-center">
          ...
          <div className="hidden lg:block">
            ...
            <p className="text-sm text-slate-400 mb-8 leading-relaxed">
              Sign in to access your PEN2PRO dashboard. Upgrade when you're ready to go all in.
            </p>
            <div className="space-y-3">
              {TIER_BENEFITS.map((t) => (
                <div key={t.tier} className="flex gap-3 rounded-xl border border-[#1A2D50] bg-[#0F1520] p-4">
