...
const TIER_CARDS = [
  {
    ...
    color: "#D4A017",
    icon: "🗺️",
    desc: "AI business blueprint, LLC checklist, brand name ideas, and a 7-day action plan — completely free.",
  },
  {
    name: "Pro — $249/mo",
    color: "#2d9cff",
    icon: "📊",
    desc: "Full roadmap, PDF export, outreach strategy, credit readiness checklist, and advanced AI refinement.",
  },
  {
    name: "Elite — $499/mo",
    color: "#00C9B1",
    icon: "⚡",
    desc: "Financial projections, done-with-you strategy, funding partner resources, and priority support.",
  },
  {
    name: "Founders Lifetime",
    color: "#D4A017",
    icon: "👑",
    desc: "One-time $1,899. Lifetime access, everything in Elite, plus P2P Command Center and AI Voice Agent.",
  },
];
  ...
  return (
    <div className="min-h-screen" style={{ background: "#080C14" }}>
      ...
      <div className="flex min-h-[calc(100vh-80px)]">
        ...
        <div
          className="hidden lg:flex lg:w-[52%] xl:w-[55%] flex-col justify-between px-12 py-16 relative overflow-hidden"
          style={{ background: "linear-gradient(145deg, #080C14 0%, #0D1830 60%, #0A1525 100%)" }}
        >
          {/* Background orbs */}
          ...
          <div className="relative">
            ...
            <h2 className="font-display text-3xl xl:text-4xl font-black text-white leading-tight mb-4">
            ...
            <p className="text-slate-400 text-base leading-relaxed max-w-md">
              PEN2PRO RMIE — Rapid Monetization Intelligence Engine — turns your idea into a real roadmap with structure, strategy, and execution support.
            </p>
          </div>

          {/* Middle: tier cards */}
          <div className="relative space-y-3">
            <p className="text-xs font-bold uppercase tracking-widest text-slate-500 mb-4">What's included at every level</p>
            {TIER_CARDS.map((t) => (
              <div
                key={t.name}
                className="flex items-start gap-4 rounded-xl border bg-[#0A1020]/60 p-4 backdrop-blur-sm"
        ...
        {/* ── RIGHT PANEL — form ── */}
        <div className="flex flex-1 items-center justify-center px-5 py-12 lg:py-20">
