...
const SIDE_PANEL_TIERS = [
  {
    color: "#22c55e",
    label: "Free Forever",
    desc: "Start with a real business roadmap. No credit card. No catch.",
  },
  {
    color: "#2d9cff",
    label: "Pro — $249/mo",
    desc: "Full 90-day execution plan, branding support, PDF export, and AI refinement.",
  },
  {
    color: "#d4af37",
    label: "Elite — $499/mo",
    desc: "Advanced strategy, financial projections, vendor/funding resources, and priority support.",
  },
  {
    color: "#d4af37",
    label: "Founders Lifetime — $1,899",
    desc: "One payment. Every feature. Forever. Only 200 spots available.",
  },
];
            ...
            <div className="flex flex-col justify-center space-y-8">
              ...
              <div>
                ...
                <p className="mt-3 text-sm text-slate-400 leading-relaxed">
                  One account gives you access to the full PEN2PRO RMIE platform — free roadmap to start, and every tier available to upgrade when you're ready to execute at the next level.
                </p>
              </div>

              {/* Tier cards */}
              <div className="space-y-3">
                {SIDE_PANEL_TIERS.map((tier) => (
                  <div
                    key={tier.label}
                  ...
                  >
                    <div
                      ...
                      style={{ background: tier.color, boxShadow: `0 0 8px ${tier.color}80` }}
                    />
                    <div>
              ...
              <div className="rounded-2xl border border-[#1A2235] bg-[#0F1520] p-5">
                <p className="text-4xl font-black mb-2" style={{ color: "#D4A017" }}>"</p>
                ...
                <div className="mt-4 border-t border-[#1A2235] pt-3">
                  <p className="text-xs font-bold text-white">Marcus T.</p>
                  <p className="text-xs text-slate-500">Pressure Washing Owner, Houston TX</p>
                </div>
              </div>
            </div>
            ...
            <div className="flex flex-col justify-center">
              <div className="rounded-2xl border border-[#1A2235] p-8" style={{ background: "#0F1520" }}>
                  ...
                  <form onSubmit={handleLogin} className="space-y-5">
                    ...
                    <div>
                      <div className="mb-1.5 flex items-center justify-between">
                        ...
                        <Link to="/waitlist" className="text-xs" style={{ color: "#D4A017" }}>
                          Forgot password?
                        </Link>
                      </div>
                      <input
                ...
                <div className="mt-6 border-t border-[#1A2235] pt-5 text-center text-sm text-slate-500">
                  ...
                  {" "}or{" "}
                  <Link to="/starter" className="font-semibold text-slate-300 hover:text-white transition-colors">
