        ...
        <div className="mb-8 grid grid-cols-2 gap-4 md:grid-cols-4">
          {[
            ...
            },
            {
              ...
              value: "Live",
              sub: "Founders offer closes August 1, 2026",
              color: "#00C9B1",
            },
            {
              label: "Current Tier",
              value: tierInfo.label,
              sub: tier === "free" ? "Upgrade to unlock all features" : "Access confirmed",
            ...
            <div className="flex flex-col gap-4 sm:flex-row sm:items-center sm:justify-between">
              <div>
                ...
                <p className="text-sm text-slate-400">
                  ...
                  Founders Lifetime is $1,899 — only 200 spots, offer closes August 1.
                </p>
              </div>
