        ...
        <div className="mb-8 grid grid-cols-2 gap-4 md:grid-cols-4">
          {[
            ...
            },
            {
              ...
              value: "Live",
              sub: "PEN2PRO — Now open for early access",
              color: "#34D399",
            },
            {
              label: "Current Tier",
              value: tierInfo.label,
              sub: tier === "free" ? "Upgrade to Pro or Elite" : "Access confirmed",
            ...
            <div className="flex flex-col gap-4 sm:flex-row sm:items-center sm:justify-between">
              <div>
                <h2 className="font-display text-lg font-bold text-white mb-1">
                  Ready to go all in? Upgrade to Pro or Elite
                </h2>
                <p className="text-sm text-slate-400">
                  Pro members get unlimited roadmaps, outreach automation, and credit/funding matching.
                  Founders Lifetime is $1,899 for life — limited to 200 spots.
                </p>
              </div>
