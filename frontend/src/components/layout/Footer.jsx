      ...
      <div className="mx-auto max-w-7xl px-5 py-14">
        <div className="grid grid-cols-1 gap-10 md:grid-cols-4">
          ...
          <div>
            ...
            <div className="rounded-xl border p-4" style={{ borderColor: "rgba(5,150,105,0.4)", background: "#0D1528" }}>
              <div className="flex items-center gap-2 mb-1">
                <span className="h-2 w-2 rounded-full bg-emerald-400 animate-pulse" />
                <p className="text-xs font-bold uppercase tracking-wide text-emerald-400">Now Live</p>
              </div>
              <p className="mt-1 text-lg font-black text-white">PEN2PRO is Open</p>
              <p className="mt-2 text-xs text-slate-500">Join as a founding member and lock in lifetime pricing before it changes.</p>
