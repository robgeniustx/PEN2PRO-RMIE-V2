        ...
        <div className="grid grid-cols-1 gap-10 md:grid-cols-5">
          ...
          <div className="md:col-span-1">
            ...
            <p className="text-sm leading-7 text-slate-500">
              AI-powered RMIE platform. Turn ideas, skills, and lived experience into income — the right way.
            </p>
          ...
          <div>
            ...
            <div className="rounded-xl border p-4" style={{ borderColor: "rgba(255,138,0,0.3)", background: "#0D1528" }}>
              ...
              <p className="mt-2 text-xs text-slate-500 leading-relaxed">
                Founding members get locked-in pricing for life. Only 200 Founder spots exist.
              </p>
