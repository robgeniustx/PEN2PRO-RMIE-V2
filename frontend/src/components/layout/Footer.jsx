        ...
        <div className="grid grid-cols-1 gap-10 md:grid-cols-4">
          ...
          <div>
            ...
            <div className="rounded-xl border p-4" style={{ borderColor: "rgba(52,211,153,0.3)", background: "#0D1528" }}>
              <p className="text-xs font-bold uppercase tracking-wide text-emerald-400">Status</p>
              <div className="flex items-center gap-2 mt-1">
                <span className="h-2.5 w-2.5 rounded-full bg-emerald-400 animate-pulse" />
                <p className="text-lg font-black text-white">Now Live</p>
              </div>
              <p className="mt-2 text-xs text-slate-500">Founding member pricing still available. Lock in your rate before it goes up.</p>
