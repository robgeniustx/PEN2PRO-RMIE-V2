    ...
    <footer className="border-t border-[#1A2D50] bg-[#0A0F1E]">
      <div className="mx-auto max-w-7xl px-5 py-14">
        <div className="grid grid-cols-1 gap-10 md:grid-cols-4">
          ...
          {/* Status */}
          <div>
            <h4 className="mb-4 text-xs font-bold uppercase tracking-widest text-slate-500">Platform Status</h4>
            <div className="rounded-xl border p-4" style={{ borderColor: "rgba(0,201,177,0.3)", background: "#0D1528" }}>
              <div className="flex items-center gap-2">
                <span className="h-2 w-2 rounded-full bg-emerald-400 animate-pulse" />
                <p className="text-xs font-bold uppercase tracking-wide" style={{ color: "#00C9B1" }}>Now Live</p>
              </div>
              <p className="mt-1 text-lg font-black text-white">Platform Open</p>
              <p className="mt-2 text-xs text-slate-500">Start free — upgrade to Pro or Elite anytime. Founders spots still available.</p>
