    ...
    <footer className="border-t border-[#1A2D50] bg-[#0A0F1E]">
      <div className="mx-auto max-w-7xl px-5 py-14">
        <div className="grid grid-cols-1 gap-10 md:grid-cols-4">
          ...
          {/* Founders Deadline */}
          <div>
            <h4 className="mb-4 text-xs font-bold uppercase tracking-widest text-slate-500">Founders Deadline</h4>
            <div className="rounded-xl border p-4" style={{ borderColor: "rgba(212,160,23,0.3)", background: "#0D1528" }}>
              <p className="text-xs font-bold uppercase tracking-wide" style={{ color: "#D4A017" }}>Founders Lifetime Closing</p>
              <p className="mt-1 text-lg font-black text-white">August 1, 2026</p>
              <p className="mt-2 text-xs text-slate-500">Only 200 spots. One payment. Locked-in pricing for life — no renewals.</p>
