      ...
      <div className="mx-auto max-w-7xl px-5 py-14">
        <div className="grid grid-cols-2 gap-10 sm:grid-cols-2 md:grid-cols-5">
          ...
          <div className="col-span-2 md:col-span-2">
            ...
            <p className="text-sm leading-7 text-slate-500 max-w-xs">
              AI-powered RMIE platform — Rapid Monetization Intelligence Engine. Turn ideas into income, the right way.
            </p>
            <p className="mt-4 text-xs text-slate-600">
              &copy; {new Date().getFullYear()} PEN2PRO. All rights reserved.
            </p>
          </div>
          ...
          <div>
            ...
            <ul className="space-y-3">
              {[
                ...
                <li key={path}>
                  <Link to={path} className="text-sm text-slate-500 hover:text-[#FF8A00] transition-colors">
                    {label}
                  </Link>
                </li>
              ))}
          ...
          <div>
            ...
            <div className="mt-6 rounded-xl border p-4" style={{ borderColor: "rgba(255,138,0,0.3)", background: "#0D1528" }}>
              ...
              <p className="mt-1 text-xs text-slate-500">Founding members lock in pricing for life.</p>
        ...
        <div className="mt-12 border-t border-[#1A2D50] pt-8 flex flex-col gap-3 sm:flex-row sm:items-center sm:justify-between">
          <p className="text-xs text-slate-600 max-w-xl">
            PEN2PRO does not guarantee income, funding approval, credit results, or business success. Results depend on individual effort, market conditions, and consistent execution.
          </p>
