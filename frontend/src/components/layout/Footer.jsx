      ...
      <div className="mx-auto max-w-7xl px-5 py-14">
        <div className="grid grid-cols-1 gap-10 md:grid-cols-5">
          ...
          <div className="md:col-span-2">
            ...
            <p className="text-sm leading-7 text-slate-500 max-w-xs">
              AI-powered Rapid Monetization Intelligence Engine. Turn ideas, skills, and lived experience into real business roadmaps.
            </p>
          ...
          <div>
            ...
            >
              <p className="text-xs font-bold uppercase tracking-wide" style={{ color: "#FF8A00" }}>
                Official Launch
              </p>
              <p className="mt-1 text-lg font-black text-white">June 15, 2026</p>
              <p className="mt-2 text-xs text-slate-500">
                Secure your spot now. Founding members get locked-in pricing for life.
              </p>
              <Link
                to="/waitlist"
                className="mt-3 block rounded-lg px-4 py-2 text-center text-xs font-black text-[#0A0F1E] btn-gold"
              >
                Secure My Spot
              </Link>
            </div>
        ...
        <div className="mt-12 border-t border-[#1A2D50] pt-8 flex flex-col gap-3 sm:flex-row sm:items-center sm:justify-between">
          <p className="text-xs text-slate-600">
            PEN2PRO does not guarantee income, funding approval, credit results, or business
            success. Results depend on individual effort and market conditions.
          </p>
          <div className="flex gap-6">
            <Link to="/privacy" className="text-xs text-slate-600 hover:text-slate-400">
              Privacy
            </Link>
            <Link to="/terms" className="text-xs text-slate-600 hover:text-slate-400">
              Terms
            </Link>
            <Link to="/disclaimer" className="text-xs text-slate-600 hover:text-slate-400">
              Disclaimer
            </Link>
          </div>
        </div>
