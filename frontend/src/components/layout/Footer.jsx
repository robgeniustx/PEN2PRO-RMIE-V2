        ...
        <div className="grid grid-cols-1 gap-10 md:grid-cols-4">
          ...
          <div>
            ...
            <div className="rounded-xl border p-4" style={{ borderColor: "rgba(255,138,0,0.3)", background: "#0D1528" }}>
              <p className="text-xs font-bold uppercase tracking-wide" style={{ color: "#FF8A00" }}>Closes August 1, 2026</p>
              <p className="mt-1 text-lg font-black text-white">Founders Lifetime</p>
              <p className="mt-2 text-xs text-slate-500">200 spots. One payment. Lifetime access. Lock in your founding price now.</p>
