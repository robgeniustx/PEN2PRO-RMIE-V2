        ...
        <div className="grid grid-cols-1 gap-10 md:grid-cols-4">
          ...
          <div>
            ...
            <div className="rounded-xl border p-4" style={{ borderColor: "rgba(255,138,0,0.3)", background: "#0D1528" }}>
              ...
              <p className="mt-1 text-lg font-black text-white">$1,899 — Lifetime</p>
              <p className="mt-2 text-xs text-slate-500">200 spots only. Full platform access for life at one price.</p>
