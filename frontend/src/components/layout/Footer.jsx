    ...
    <footer className="border-t border-[#1A2D50] bg-[#0A0F1E]">
      <div className="mx-auto max-w-7xl px-5 py-14">
        <div className="grid grid-cols-1 gap-10 md:grid-cols-4">
          ...
          {/* Now Live */}
          <div>
            <h4 className="mb-4 text-xs font-bold uppercase tracking-widest text-slate-500">Join Now</h4>
            <div className="rounded-xl border p-4" style={{ borderColor: "rgba(255,138,0,0.3)", background: "#0D1528" }}>
              <p className="flex items-center gap-2 text-xs font-bold uppercase tracking-wide" style={{ color: "#FF8A00" }}>
                <span className="h-2 w-2 rounded-full bg-emerald-400 inline-block animate-pulse" />Platform Live
              </p>
              <p className="mt-1 text-lg font-black text-white">Early Access Open</p>
              <p className="mt-2 text-xs text-slate-500">Founding members lock in pricing for life. Limited spots remain.</p>
