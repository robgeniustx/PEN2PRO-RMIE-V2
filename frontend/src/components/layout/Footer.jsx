        ...
        <div className="grid grid-cols-1 gap-10 md:grid-cols-5">
          ...
          <div className="md:col-span-2">
            ...
            <p className="text-sm leading-7 text-slate-500 max-w-xs">
              AI-powered Rapid Monetization Intelligence Engine. Turn ideas into income — the right way. Built for entrepreneurs, veterans, returning citizens, and working-class builders.
            </p>
            <p className="mt-4 text-xs text-slate-600">© {new Date().getFullYear()} PEN2PRO. All rights reserved.</p>
            <p className="mt-1 text-xs text-slate-700">
              Founder: Robert Earl Green Jr. · Service-Connected Veteran · Houston, TX
            </p>
          </div>
