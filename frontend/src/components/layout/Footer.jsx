          ...
          <div>
            ...
            <div className="rounded-xl border p-4" style={{ borderColor: "rgba(0,201,177,0.3)", background: "#0D1528" }}>
              <div className="flex items-center gap-2 mb-1">
                ...
                <p className="text-xs font-bold uppercase tracking-wide text-teal-400">Now Live</p>
              </div>
              <p className="mt-1 text-lg font-black text-white">Founding Spots Open</p>
              <p className="mt-2 text-xs text-slate-500">136 of 200 founding spots claimed. Lock in your pricing for life.</p>
