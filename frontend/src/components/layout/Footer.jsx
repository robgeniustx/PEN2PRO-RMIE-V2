          ...
          <div>
            ...
            <div className="rounded-xl border p-4" style={{ borderColor: "rgba(255,138,0,0.3)", background: "#0D1528" }}>
              <div className="flex items-center gap-2 mb-1">
                ...
                <p className="text-xs font-bold uppercase tracking-wide" style={{ color: "#FF8A00" }}>Now Accepting Members</p>
              </div>
              <p className="mt-1 text-lg font-black text-white">Founding Access Open</p>
              <p className="mt-2 text-xs text-slate-500">Founding members get locked-in pricing and first access to every new feature.</p>
