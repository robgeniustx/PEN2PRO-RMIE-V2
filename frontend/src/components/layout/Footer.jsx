        ...
        <div className="grid grid-cols-1 gap-10 md:grid-cols-4">
          ...
          <div>
            ...
            <div className="rounded-xl border p-4" style={{ borderColor: "rgba(212,175,55,0.35)", background: "#0D1528" }}>
              <p className="text-xs font-bold uppercase tracking-wide" style={{ color: "#d4af37" }}>Now Live — 200 Spots</p>
              <p className="mt-1 text-lg font-black text-white">Founders Lifetime</p>
              <p className="mt-2 text-xs text-slate-500">Lock in lifetime access at $1,899 before August 1. 200 spots. No renewals. Ever.</p>
