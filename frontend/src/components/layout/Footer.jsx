          ...
          <div>
            ...
            <div className="rounded-xl border p-4" style={{ borderColor: "rgba(52,211,153,0.3)", background: "#0D1528" }}>
              <div className="flex items-center gap-2">
                ...
                <p className="text-xs font-bold uppercase tracking-wide text-emerald-400">Live — Early Access</p>
              </div>
              <p className="mt-1 text-lg font-black text-white">Open Now</p>
              <p className="mt-2 text-xs text-slate-500">Free roadmap available today. Founding members get locked-in pricing for life.</p>
