          ...
          <div>
            ...
            <div className="rounded-xl border p-4" style={{ borderColor: "rgba(255,138,0,0.3)", background: "#0D1528" }}>
              <div className="flex items-center gap-2 mb-1">
                ...
                <p className="text-xs font-bold uppercase tracking-wide" style={{ color: "#FF8A00" }}>Platform Is Live</p>
              </div>
              <p className="mt-1 text-lg font-black text-white">200 Spots Only</p>
              <p className="mt-2 text-xs text-slate-500">Founding members lock in pricing for life. Limited spots remaining.</p>
