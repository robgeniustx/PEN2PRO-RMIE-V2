        ...
        <div className="grid grid-cols-1 gap-10 md:grid-cols-4">
          ...
          <div>
            ...
            <div className="rounded-xl border p-4" style={{ borderColor: "rgba(255,138,0,0.3)", background: "#0D1528" }}>
              ...
              <p className="mt-1 text-base font-black text-white">200 Founder Spots</p>
              <p className="mt-2 text-xs text-slate-500">Founding members lock in pricing for life and get first access to every new feature.</p>
