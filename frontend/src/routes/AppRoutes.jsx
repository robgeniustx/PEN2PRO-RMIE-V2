...
export default function AppRoutes() {
  return (
    <Routes>
      ...
      <Route path="/admin/waitlist" element={<ProtectedRoute><AdminWaitlistPage /></ProtectedRoute>} />
      <Route path="/admin/analytics" element={<ProtectedRoute><AdminAnalyticsPage /></ProtectedRoute>} />
      <Route path="/admin/feature-usage" element={<ProtectedRoute><AdminFeatureUsagePage /></ProtectedRoute>} />
      <Route path="/admin/conversions" element={<ProtectedRoute><AdminConversionsPage /></ProtectedRoute>} />
