...
export const DASHBOARD_NAV = [
  ...
  { key: "ai-voice-agent", label: "AI Voice Agent", requiredPlan: "pro", section: "AI" },
  ...
  { key: "websites", label: "Websites", requiredPlan: "pro", section: "Marketing" },
...
const MODULE_COPY = {
  ...
  "ai-voice-agent": "P2P AI Voice (Basic) for intake, missed-call response, lead capture, and upgrade-ready call workflows.",
  ...
  websites: "Website builder projects, landing pages, SEO sections, and publishing status for Pro and above.",
