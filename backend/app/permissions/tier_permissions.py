...
def has_tier(required_tier: str, actual_tier: str) -> bool:
    """True if actual_tier meets or exceeds required_tier in the plan hierarchy."""
    return TIER_ORDER.index(normalize_tier(actual_tier)) >= TIER_ORDER.index(normalize_tier(required_tier))
