...
class AutomationService:
    ...
    def log_activity(self,action_type,description,event_metadata=None): l=ActivityLog(action_type=action_type,description=description,event_metadata=event_metadata); self.db.add(l); return l
