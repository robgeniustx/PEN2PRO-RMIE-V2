...
class AutomationService:
    ...
    def log_activity(self,action_type,description,metadata=None): l=ActivityLog(action_type=action_type,description=description,extra_data=metadata); self.db.add(l); return l
