...
class AutomationService:
    ...
    def log_activity(self,action_type,description,extra_metadata=None): l=ActivityLog(action_type=action_type,description=description,extra_metadata=extra_metadata); self.db.add(l); return l
