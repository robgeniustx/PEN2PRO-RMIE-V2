...
class AutomationService:
    ...
    def log_activity(self,action_type,description,extra_data=None): l=ActivityLog(action_type=action_type,description=description,extra_data=extra_data); self.db.add(l); return l
