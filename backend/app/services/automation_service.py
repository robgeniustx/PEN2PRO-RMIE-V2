...
class AutomationService:
    ...
    def log_activity(self,action_type,description,activity_metadata=None): l=ActivityLog(action_type=action_type,description=description,activity_metadata=activity_metadata); self.db.add(l); return l
