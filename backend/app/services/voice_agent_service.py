...
INDUSTRY_SCRIPT_MODES = {
    ...
    "insurance-company": {
        "greeting": "Thank you for calling [Agency Name] Insurance. I'm the intake assistant. I don't provide policy advice, but I can connect you with a licensed agent and get your information started. Are you looking for a quote or do you have a question about an existing policy?",
        ...
        "follow_up_sms": "Hi {name}! A licensed agent from {agency} will call you at {phone} within 1 business day to review your insurance options.",
