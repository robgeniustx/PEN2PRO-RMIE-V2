...
1. Inspect the current file structure (`frontend/src`, routes, components, pages).
2. Identify the routing system (React Router, etc.) and the main App/router file.
3. Identify the navigation/header component.
4. Identify existing pages/components.
5. Report exactly what is missing or broken.
...
- Elite → advanced strategist, financial projections, legal guidance, vendors at `/elite`
