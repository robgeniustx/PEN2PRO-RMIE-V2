...
- Use Tailwind-style premium dark design if Tailwind is available; otherwise use clean CSS.
- Make every CTA button route somewhere real.
- Make every menu item work.
- Connect every tier button (Free, Pro, Elite, Founders) to the correct page/flow.
...
- /waitlist /affiliate /funding /credit-repair /admin /roadmap

Funnel logic to enforce:
- Free Forever → starter business blueprint (no login required)
- Pro → full roadmap, branding, export, stronger AI refinement
- Elite → strategist guidance, financial projections, legal-foundation, vendor integrations, priority support
